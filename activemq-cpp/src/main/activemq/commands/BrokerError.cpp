...
ActiveMQException BrokerError::createExceptionObject()
{
    ...
    {
        cause =
            new cms::CMSSecurityException(this->message, NULL, cmsStackTrace);
    }
    ...
    {
        cause =
            new cms::MessageEOFException(this->message, NULL, cmsStackTrace);
    }
    else if (exceptionClass == "MessageFormatException")
    {
        cause =
            new cms::MessageFormatException(this->message, NULL, cmsStackTrace);
    }
    ...
    {
        cause =
            new cms::IllegalStateException(this->message, NULL, cmsStackTrace);
    }
