...
namespace core
{
    ...
    /**
     * Interface for a Policy object that controls message Prefetching on
     * various destination types in ActiveMQ-CPP.
     *
     * @since 3.2.0
     */
    ...
    public:
        ...
        /**
         * Given a requested value for a new prefetch limit, compare it against
         * some max prefetch value and return either the requested value or the
         * maximum allowable value for prefetch.
         *
         * @return the allowable value for a prefetch limit, either requested or
         * the max.
         */
         ...
         *
         * @return pointer to a new PrefetchPolicy instance that is a clone of
         * this one.
         */
         ...
         * looks for properties named with the prefix cms.PrefetchPolicy.XXX
         * where XXX is the name of a property with a public setter method.  For
         * instance cms.PrefetchPolicy.topicPrefetch will be used to set the
         * value of the topic prefetch limit.
         *
