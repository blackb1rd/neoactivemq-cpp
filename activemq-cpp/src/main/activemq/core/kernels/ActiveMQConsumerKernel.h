...
namespace core
{
    namespace kernels
    {
        ...
        class AMQCPP_API ActiveMQConsumerKernel : public cms::MessageConsumer,
                                                  public Dispatcher
        {
        private:
            /**
             * Internal Class that holds Members of this class, allows for
             * changes without API breakage.
             */
        ...
        public:  // ActiveMQConsumerKernel Methods
            /**
             * Method called to acknowledge all messages that have been received
             * so far.
             *
            ...
            /**
             * Called to Roll back the current set of messages in this
             * Transaction
             *
             * @throw ActiveMQException if an error occurs while performing the
             * operation.
             ...
             * there is one, return true if not all dispatched, or false if no
             * listener or all pending messages have been dispatched.
             */
            bool iterate();
            ...
            /**
             * Signals that a Failure occurred and that anything in-progress in
             * the consumer should be cleared.
             */
            ...
            /**
             * Will Message's in a transaction be acknowledged using the
            ...
            /**
             * Set if Message's in a transaction be acknowledged using the
             * Individual Acknowledge mode.
             *
             * @param value
            ...
            /**
             * Returns the delay after a failover before Message redelivery
             * starts.
             *
            ...
            /**
             * Sets the time in milliseconds to delay after failover before
             * starting message redelivery.
             *
             * @param value
             *      Time in milliseconds to delay after failover for redelivery
             * start.
             */
            ...
            /**
             * @return the number of Message's this consumer is waiting to
             * Dispatch.
             */
            int getMessageAvailableCount() const;

            /**
             * Sets the RedeliveryPolicy this Consumer should use when a
             * rollback is performed on a transacted Consumer.  The Consumer
             * takes ownership of the passed pointer.  The Consumer's redelivery
             * policy can never be null, a call to this method with a NULL
             * pointer is ignored.
             *
             * @param policy
             ...
             * Consumer retains ownership of this pointer so the caller should
             * not delete it.
             *
            ...
            /**
             * Sets the Exception that has caused this Consumer to be in a
             * failed state.
             *
             * @param error
            ...
            /**
             * Sets the current prefetch size for the consumer as indicated by a
             * Broker ConsumerControl command.
             */
            void setPrefetchSize(int prefetchSize);

            /**
             * Checks if the given destination is the Destination that this
             ...
             * any outstanding delivered Messages.  A value less than one means
            ...
            /**
             * Sets the time in Milliseconds to schedule an automatic
             * acknowledge of outstanding messages when optimize acknowledge is
             * enabled.  A value less than one means disable any scheduled
             * tasks.
             *
             * @param value
            ...
            /**
             * Returns true if the given MessageDispatch is expected to be
             * redelivered in the currently open transaction.  This would be
             * true for any message that was previously delivered in a
             * transaction and a failover occurred prior to the transaction
             * being completed.
             *
             * @return true if the given dispatch needs to be delivered to this
             * consumer to recover.
             */
        ...
        protected:
            /**
             * Used by synchronous receive methods to wait for messages to come
             * in.
             * @param timeout - The maximum number of milliseconds to wait
             * before returning.
             *
             * If -1, it will block until a messages is received or this
             * consumer is closed. If 0, will not block at all.  If > 0, will
             * wait at a maximum the specified number of milliseconds before
             * returning.
             ...
             * @param messageExpired - flag indicating if the message has
             * expired.
             */
