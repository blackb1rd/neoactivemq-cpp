...
namespace transport
{
    ...
    /**
     * A filter on the transport layer.  Transport filters implement the
     * Transport interface and optionally delegate calls to another Transport
     * object.
     *
     * @since 1.0
     */
    ...
    protected:
         ...
         * This method will always be called before the next transport in the
         * chain is called in order to allow this transport a chance to
        ...
        /**
         * Subclasses can override this method to do their own post startup
         * work.  This method will always be called after the doStart() method
         * and the next transport's own start() methods have been successfully
         * run.
         */
         ...
         * This method will always be called before the next transport's own
         * stop() method or this filter's own doStop() method is called.
         */
        ...
        /**
         * Subclasses can override this method to do their own stop work.  This
         * method is always called after all the next transports have been
         * stopped to prevent this transport for destroying resources needed by
         * the lower level transports.
         */
        ...
        /**
         * Subclasses can override this method to do their own close work.  This
         * method is always called after all the next transports have been
         * closed to prevent this transport for destroying resources needed by
         * the lower level transports.
         */
