...
namespace transport
{
    ...
    public:
        ...
        /**
         * Registers a new TransportFactory with this Registry.  If a Factory
        ...
        /**
         * Retrieves a list of the names of all the Registered Transport's in
         * this Registry.
         *
         * @return stl vector of strings with all the Transport names
         * registered.
         */
