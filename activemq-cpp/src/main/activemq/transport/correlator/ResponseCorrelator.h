...
namespace transport
{
    namespace correlator
    {
         ...
         * asynchronous responses with requests.  Non-response messages are
         * simply sent directly to the CommandListener. It owns the transport
         * that it
         */
        ...
        public:
            /**
             * Creates a new ResponseCorrelator transport filter that wraps the
             * given transport.
             *
             * @param next
        ...
        public:  // Transport Methods
             ...
             * thread.  In the case of a response object, updates the request
             * map and notifies those waiting on the response.  Non-response
             * messages are just delegated to the command listener.
             *
             * @param command
