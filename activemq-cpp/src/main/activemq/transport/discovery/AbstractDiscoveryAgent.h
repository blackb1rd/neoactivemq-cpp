...
namespace transport
{
    namespace discovery
    {
         ...
         * to create a DiscoveryAgent instance without needing to implement a
         * lot of boilerplate code.
         *
         * @since 3.9.0
         */
        class AMQCPP_API AbstractDiscoveryAgent : public DiscoveryAgent,
        ...
        public:
            ...
            /**
             * Gets the configured service to publish, not all agents can
             * publish so this value may not mean that an actual service
             * advertisement is ever done.
             *
             ...
             * that has not been seen is kept in the list of discovered services
             * before being idle to long.  Also this value controls how often
             * this service will advertise itself if it supports that.
             *
             * @param interval
             ...
             *
             * @param multiplier
             *      The back multiplier to use when calculating the next
             * recovery time.
             */
             ...
             * recovery time.
             *
             * @return the configured backoff multiplier for calculating the
             * next recovery time.
             */
             ...
             * attempt a reconnect on a discovered service.
             *
             ...
             * service is considered to be failed and removed.
             *
             ...
             * attempted before a service is considered to be failed.
             *
             ...
             *      The maximum time in milliseconds to limit the reconnect
             * delays.
             */
             ...
             * limits the amount of time that reconnect will wait when
             ...
             * new connection is made or the maximum number of attempts is
             * exceeded.  Using an exponential back-off can reduce CPU overhead
             * but can also lead to a longer time to reconnect to a service that
             ...
             * service are delayed by an exponentially growing time factor.
             *
            ...
            /**
             * Sets the discovery group that this agent is assigned.  The
             * default value for this group is "default".
             *
             * @param group
        ...
        protected:
             ...
             * however some agents may require special handling of their
             * discovery mechanisms so it is allowable for this method to be
             * overridden.  Implementors of this method must ensure that the run
             * method will return quickly once the started value becomes false
             * or the Thread is interrupted.
             */
            virtual void run();

            virtual void processLiveService(const std::string& brokerName,
        ...
        protected:
             ...
             * necessary resource allocation prior to the completion of the
             * start call.
             */
            ...
            /**
             * The real agent class must implement this method to perform any
             * necessary resource cleanup prior to the completion of the stop
             * call.
             */
             ...
             * of this clients service.  Not all agents can do this so this
             * method should be a no-op if this is not supported.
             */
            virtual void doAdvertizeSelf() = 0;

            /**
             * Performs the actual discovery operation for this agent.  This
             * method is called in the worker thread context of the
             * AbstractDiscoveryAgent and should not block forever.  The method
             * will be called repeatedly to allow the agent to continually probe
             * for new services.
             */
