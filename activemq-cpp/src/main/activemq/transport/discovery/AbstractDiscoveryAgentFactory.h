...
namespace transport
{
    namespace discovery
    {
        ...
        class AMQCPP_API AbstractDiscoveryAgentFactory
        ...
        public:
             ...
             * should implement the doCreateAgent method to do the actual agent
             * creation and override the doConfigureAgent if they have
             * additional URI options that need to be applied before returning
        ...
        protected:
             ...
             *
             * After this method is called by createAgent the configuration
             * method will be invoked to allow the URI options to be applied.
             *
        ...
        protected:
             ...
             * created.  The default implementation of this method will
             * configure all the known AbstractDiscoveryAgent options using the
             * URI options given.  Subclasses can override this method to apply
             * addition URI options specific to the agent type being created but
             * should also call this method to ensure that all options are
             * applied.
             *
             * @param agent
             *      The AbstractDiscoveryAgent instance that is to be
             * configured.
             * @param options
