...
namespace transport
{
    namespace discovery
    {
         ...
         * discovered broker services.
         *
         * @since 3.9.0
         */
        class AMQCPP_API DiscoveredBrokerData
            : public activemq::commands::DiscoveryEvent
        {
        private:
        ...
        public:
            ...
            DiscoveredBrokerData(const std::string& brokerName,
             ...
             *
             * @param recoveryTime
             *      The next time a recovery of this service should be
             * attempted.
             */
