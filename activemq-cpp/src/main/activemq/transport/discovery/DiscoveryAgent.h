...
namespace transport
{
    namespace discovery
    {
        ...
        public:
             ...
             * URI can be used to configure the discovery agent.
             */
            virtual void setDiscoveryURI(
                const decaf::net::URI& discoveryURI) = 0;
             ...
             * remove of a discovered service.
             *
             * @param listener
             *      Pointer to a listener instance that will be notified, or
             * null to reset.
             */
            virtual void setDiscoveryListener(DiscoveryListener* listener) = 0;

            /**
             * Register a service with this DiscoveryAgent.  If the agent
             * supports advertisement then the new service will be broadcast.
             *
             * @param service
             ...
             * DiscoveryAgent notices the service's failure.  That process can
             * use this method to notify the DiscoveryAgent of the failure so
             * that other listeners of this DiscoveryAgent can also be made
             ...
             * service.
             *
             * @throws IOException if an error occurs processing the failure
             * event.
             */
            ...
            /**
             * Returns a descriptive string that represents this discovery
             * agent.
             *
