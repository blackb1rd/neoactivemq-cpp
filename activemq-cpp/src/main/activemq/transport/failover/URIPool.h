...
namespace transport
{
    namespace failover
    {
        ...
        public:
            ...
            /**
             * Creates a new URI Pool using the given list as the initial Free
             * List.
             *
            ...
            /**
             * Assignment operator, copies the contents of the given URIPool
             * into this one.
             *
             * @param uris
            ...
            /**
             * Returns the URI that is considered to be this Pools Priority URI,
             * this is always the first URI in the list of URIs that this pool
             * was created with.
             */
            ...
            /**
             * Adds a URI to the free list, callers that have previously taken
             * one using the <code>getURI</code> method should always return the
             * URI when they close the resource that was connected to that URI.
             *
             * @param uri - a URI previously taken from the pool.
             *
             * @return true if the URI was added or false if its already in the
             * list.
             */
            bool addURI(const decaf::net::URI& uri);

            /**
             * Adds a List of URIs to this Pool, the method checks for
             * duplicates already in the pool and does not add those.
             *
             * @param uris - List of URIs to add into the Pool.
             *
             * @return true if any URI was added or false if they were already
             * in the list.
             */
             ...
             *
             * @return true if the URI was removed or false if no change was
             * made.
             */
            ...
            /**
             * Sets if the URI's that are taken from the pool are chosen
             * Randomly or are taken in the order they are in the list.
             *
