...
namespace transport
{
    namespace tcp
    {
        ...
        /**
         * Implements a TCP/IP based transport filter, this transport is meant
         * to wrap an instance of an IOTransport.  The lower level transport
         * should take care of managing stream reads and writes.
         */
        ...
        public:
            /**
             * Creates a new instance of a TcpTransport, the transport is left
             * unconnected and is in a unusable state until the connect method
             * is called.
             *
             * @param next
        ...
        protected:
            ...
            /**
             * Creates a Socket and configures it before attempting to connect
             * to the location specified by the URI passed in.
             */
            void connect();

            /**
             * Create an unconnected Socket instance to be used by the transport
             * to communicate with the broker.
             *
             * @return a newly created unconnected Socket instance.
             *
             * @throw IOException if there is an error while creating the
             * unconnected Socket.
             */
            virtual decaf::net::Socket* createSocket();

            /**
             * Using options from configuration URI, configure the socket
             * options before the Socket instance is connected to the Server.
             * Subclasses can override this option to set more configuration
             * options, they should called the base class version to allow the
             * default set of Socket options to also be configured.
             *
             * @param socket
