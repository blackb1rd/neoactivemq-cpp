...
////////////////////////////////////////////////////////////////////////////////
void MarshallingSupport::writeString(decaf::io::DataOutputStream& dataOut,
...
////////////////////////////////////////////////////////////////////////////////
void MarshallingSupport::writeString16(decaf::io::DataOutputStream& dataOut,
                                       const std::string&           value)
{
    try
    {
...
////////////////////////////////////////////////////////////////////////////////
void MarshallingSupport::writeString32(decaf::io::DataOutputStream& dataOut,
                                       const std::string&           value)
{
    try
    {
...
////////////////////////////////////////////////////////////////////////////////
std::string MarshallingSupport::asciiToModifiedUtf8(
    ...
    try
    {
        if (asciiString.length() > 0)
        {
            ...
            for (std::size_t i = 0; i < length; ++i)
            {
                ...
                // Written to allow for expansion to wide character strings at
                // some point, as it stands now the value can never be > 255
                // since the string class returns a single byte char.
            ...
            for (std::size_t i = 0; i < length; i++)
            {
                ...
                {
                    utfBytes[utfIndex++] =
                        (char)(0xc0 | (0x1f & (charValue >> 6)));
                    utfBytes[utfIndex++] = (char)(0x80 | (0x3f & charValue));
                }
                else
                {
                    utfBytes[utfIndex++] =
                        (char)(0xe0 | (0x0f & (charValue >> 12)));
                    utfBytes[utfIndex++] =
                        (char)(0x80 | (0x3f & (charValue >> 6)));
                    utfBytes[utfIndex++] = (char)(0x80 | (0x3f & charValue));
                }
            }
...
////////////////////////////////////////////////////////////////////////////////
std::string MarshallingSupport::modifiedUtf8ToAscii(
