...
namespace util
{
    ...
    public:  // Openwire Type Marshalling methods
        /**
         * Write the string object to the given DataOutputStream as Raw bytes,
         * no string encoding is done on this char values in the string.  User
         * must encode to Modified UTF-8 as needed.
         *
         * @param dataOut
         ...
         * Write the string object to the given DataOutputStream as Raw bytes,
         * no string encoding is done on this char values in the string.  User
         * must encode to Modified UTF-8 as needed.  This method write out only
         * the size as a short and the string data no Openwire Type tag is
         * appended.
         *
         * @param dataOut
         *      The DataOutputStream to write the String data to.
         ...
         * @throws IOException if an I/O error occurs while writing the string.
         */
        static void writeString16(decaf::io::DataOutputStream& dataOut,
                                  const std::string&           value);
         ...
         * no string encoding is done on this char values in the string.  User
         * must encode to Modified UTF-8 as needed.  This method write out only
         * the size as a int and the string data no Openwire Type tag is
         * appended.
         *
         * @param dataOut
         *      The DataOutputStream to write the String data to.
         ...
         * @throws IOException if an I/O error occurs while writing the string.
         */
        static void writeString32(decaf::io::DataOutputStream& dataOut,
                                  const std::string&           value);

        /**
         * Reads an Openwire encoded string from the provided DataInputStream.
         * No string processing is performed by this method, clients that know
         * the data contains UTF-8 encoded content must use one of the utility
         * methods of this class to decode the UTF-8 data.
         *
    ...
    public:
        ...
        /**
         * Given an ASCII String with byte values [0..255] convert the string to
         * a string containing the modified UTF-8 form of that same string. This
         * allows an ASCII string containing values greater than 127 as well as
         * embedded NULLs to be sent to a Java client.
         *
         * @param asciiString
        ...
        /**
         * Given a string that contains bytes in the Java Modified UTF-8 format
         * convert that string back into ASCII values from [0..255].  This will
         * handle any string sent from a Java client which contains values
         * within the [0..255] range or has embedded Nulls.  Strings that have
         * encoded values greater than 255 will cause an exception to be thrown.
         *
