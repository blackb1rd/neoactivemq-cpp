...
////////////////////////////////////////////////////////////////////////////////
PrimitiveMap::PrimitiveMap(
    const decaf::util::Map<std::string, PrimitiveValueNode>& src)
...
std::string PrimitiveMap::toString() const
{
    ...
    while (entries->hasNext())
    {
        ...
        stream << "map[" << entry.getKey()
               << "] = " << entry.getValue().toString() << std::endl;
    }
...
////////////////////////////////////////////////////////////////////////////////
PrimitiveValueNode::PrimitiveType PrimitiveMap::getValueType(
...
////////////////////////////////////////////////////////////////////////////////
std::vector<unsigned char> PrimitiveMap::getByteArray(
    const std::string& key) const
{
    PrimitiveValueNode node = this->get(key);
