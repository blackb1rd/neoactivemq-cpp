...
////////////////////////////////////////////////////////////////////////////////
void PrimitiveValueNode::setValue(const PrimitiveValue& value,
...
bool PrimitiveValueNode::getBool() const
{
    if (valueType != BOOLEAN_TYPE)
    {
        throw decaf::util::NoSuchElementException(
            __FILE__,
            __LINE__,
            "PrimitiveValue is not BOOLEAN_TYPE");
    }
...
unsigned char PrimitiveValueNode::getByte() const
{
    if (valueType != BYTE_TYPE)
    {
        throw decaf::util::NoSuchElementException(
            __FILE__,
            __LINE__,
            "PrimitiveValue is not BYTE_TYPE");
    }
...
char PrimitiveValueNode::getChar() const
{
    if (valueType != CHAR_TYPE)
    {
        throw decaf::util::NoSuchElementException(
            __FILE__,
            __LINE__,
            "PrimitiveValue is not CHAR_TYPE");
    }
...
short PrimitiveValueNode::getShort() const
{
    if (valueType != SHORT_TYPE)
    {
        throw decaf::util::NoSuchElementException(
            __FILE__,
            __LINE__,
            "PrimitiveValue is not SHORT_TYPE");
    }
...
int PrimitiveValueNode::getInt() const
{
    if (valueType != INTEGER_TYPE)
    {
        throw decaf::util::NoSuchElementException(
            __FILE__,
            __LINE__,
            "PrimitiveValue is not INTEGER_TYPE");
    }
...
long long PrimitiveValueNode::getLong() const
{
    if (valueType != LONG_TYPE)
    {
        throw decaf::util::NoSuchElementException(
            __FILE__,
            __LINE__,
            "PrimitiveValue is not LONG_TYPE");
    }
...
double PrimitiveValueNode::getDouble() const
{
    if (valueType != DOUBLE_TYPE)
    {
        throw decaf::util::NoSuchElementException(
            __FILE__,
            __LINE__,
            "PrimitiveValue is not DOUBLE_TYPE");
    }
...
float PrimitiveValueNode::getFloat() const
{
    if (valueType != FLOAT_TYPE)
    {
        throw decaf::util::NoSuchElementException(
            __FILE__,
            __LINE__,
            "PrimitiveValue is not FLOAT_TYPE");
    }
...
std::string PrimitiveValueNode::getString() const
{
    if (valueType != STRING_TYPE)
    {
        throw decaf::util::NoSuchElementException(
            __FILE__,
            __LINE__,
            "PrimitiveValue is not STRING_TYPE");
    }
...
////////////////////////////////////////////////////////////////////////////////
void PrimitiveValueNode::setList(
    const decaf::util::List<PrimitiveValueNode>& lvalue)
{
    clear();
    valueType       = LIST_TYPE;
    ...
    const decaf::util::Map<std::string, PrimitiveValueNode>& lvalue)
{
    ...
    valueType = MAP_TYPE;
    value.mapValue =
        new decaf::util::StlMap<std::string, PrimitiveValueNode>(lvalue);
}

////////////////////////////////////////////////////////////////////////////////
const decaf::util::Map<std::string, PrimitiveValueNode>&
