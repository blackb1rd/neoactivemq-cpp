                          ...
                          decaf::util::Properties& properties)
{
    try
    {
        ...
        properties.setProperty("transport.uri",
                               tokenizer.nextToken("&?").substr(3));
...
std::string URISupport::replaceEnvValues(const std::string& value)
{
    try
    {
        ...
        // surrounded by an { and } bracket.  once done we remove the inner
        // value and look up the env var.
        if (value.at(0) == '$')
        {
...
////////////////////////////////////////////////////////////////////////////////
void URISupport::parseComposite(const URI&         uri,
                                CompositeData&     rc,
...
////////////////////////////////////////////////////////////////////////////////
std::string URISupport::stripPrefix(const std::string& value,
...
////////////////////////////////////////////////////////////////////////////////
URI URISupport::applyParameters(const URI&        uri,
    ...
    if (!queryParameters.isEmpty())
    {
        ...
        for (; iter != keys.end(); ++iter)
        {
            ...
            if (option.find(optionPrefix) == 0)
            {
                ...
                newQuery.append(newKey).append("=").append(
                    queryParameters.getProperty(option));
            }
        }
