...
namespace wireformat
{
    namespace openwire
    {
        ...
        public:
            /**
             * Utility method for Tight Marshaling the given object to the
             * boolean stream passed.
            ...
            /**
             * Utility method that will Tight marshal some internally nested
             * object that implements the DataStructure interface.  Writes the
             * data to the Data Output Stream provided.
            ...
            /**
             * Utility method used to Unmarshal a Nested DataStructure type
             * object from the given DataInputStream.  The DataStructure
             * instance that is returned is now the property of the caller.
             * @param dis - DataInputStream to read from
             * @param bs - BooleanStream to read from
             * @return Newly allocated DataStructure Object
             * @throws IOException if an error occurs.
             */
            commands::DataStructure* tightUnmarshalNestedObject(
            ...
            /**
             * Utility method to loosely Marshal an object that is derived from
             * the DataStrucutre interface.  The marshaled data is written to
             * the passed in DataOutputStream.
             ...
             * @return maximum inactivity duration initial delay value in
             * milliseconds.
             */
             ...
             * @param value - the Max inactivity Initial Delay duration value in
             * milliseconds.
             */
        ...
        protected:
            /**
             * Perform the actual unmarshal of data from the given
             * DataInputStream return the unmarshalled DataStrucutre object once
             * done, caller takes ownership of this object.  This method can
             * return null if the type of the object to unmarshal is NULL, empty
             * data.
             *
             * @param transport
             *      The Transport that is unmarshaling (used for partial storage
             * access)
             * @param dis
             ...
             */
            commands::DataStructure* doUnmarshal(
                const activemq::transport::Transport* transport,
                decaf::io::DataInputStream*           dis);

            /**
             * Cleans up all registered Marshallers and empties the
             * dataMarshallers vector.  This should be called before a
             * reconfiguration of the version marshallers, or on destruction of
             * this object
             */
