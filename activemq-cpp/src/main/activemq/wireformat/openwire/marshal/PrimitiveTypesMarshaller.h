...
namespace wireformat
{
    namespace openwire
    {
        namespace marshal
        {
             ...
             * map to the Openwire Format's expectation of what the map looks
             * like on the wire.
             */
            ...
            public:
                 ...
                 *
                 * @throws Exception if an error occurs during the marshaling
                 * process.
                 */
                 ...
                 *
                 * @throws Exception if an error occurs during the unmarshal
                 * process.
                 */
                 ...
                 *
                 * @param map
                 *      The List to populate with values from the marshaled
                 * data.
                 * @param buffer
                 *      The byte buffer containing the marshaled Map.
                 *
            ...
            public:
                 ...
                 *      Map to Marshal.
                 * @param dataOut
                 *      Reference to a DataOutputStream to write the marshaled
                 * data to.
                 *
                 * @throws Exception if an error occurs during the marshaling
                 * process.
                 */
                static void marshalMap(const util::PrimitiveMap*    map,
                 ...
                 *
                 * @param dataIn
                 *      The DataInputStream instance to read the marshaled
                 * PrimitiveMap from.
                 *
                 ...
                 * process.
                 */
                static util::PrimitiveMap* unmarshalMap(
                 ...
                 * process.
                 */
                static void marshalList(const util::PrimitiveList*   list,
                                        decaf::io::DataOutputStream& dataOut);
                 ...
                 * PrimitiveList from.
                 *
                 * @return a pointer to a newly allocated PrimitiveList
                 * instnace.
                 *
                 * @throws Exception if an error occurs during the unmarshal
                 * process.
                 */
                static util::PrimitiveList* unmarshalList(
                    decaf::io::DataInputStream& dataIn);

            protected:
                /**
                 * Marshal a Map of Primitives to the given OutputStream, can
                 * result in recursive calls to this method if the map contains
                 * maps of maps.
                 *
                 * @param dataOut - the DataOutputStream to write to
                 * @param map - the ValueNode to write.
                 *
                 * @throws IOException if an I/O error occurs during this
                 * operation.
                 */
                static void marshalPrimitiveMap(
                    decaf::io::DataOutputStream&                      dataOut,
                    const decaf::util::Map<std::string,
                                           util::PrimitiveValueNode>& map);

                /**
                 * Marshal a List of Primitives to the given OutputStream, can
                 * result in recursive calls to this method if the list contains
                 * lists of lists.
                 * @param dataOut - the DataOutputStream to write to
                 ...
                 * operation.
                 */
                static void marshalPrimitive(
                    decaf::io::DataOutputStream&    dataOut,
                    const util::PrimitiveValueNode& value);

                /**
                 * Unmarshals a Map of Primitives from the given InputStream,
                 * can result in recursive calls to this method if the map
                 * contains maps of maps.
                ...
                /**
                 * Unmarshals a List of Primitives from the given InputStream,
                 * can result in recursive calls to this method if the list
                ...
                /**
                 * Unmarshals a Primitive Type from the stream, and returns it
                 * as a value Node.
                 * @param dataIn - DataInputStream to read from.
