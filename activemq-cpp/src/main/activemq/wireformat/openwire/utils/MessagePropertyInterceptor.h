...
namespace wireformat
{
    namespace openwire
    {
        namespace utils
        {
             ...
             * set properties in order to capture the calls that use the
             * reserved JMS properties and get and set them in the OpenWire
             * Message properties.
             *
             * Currently the only properties that are intercepted and handled
             * are:
             *
            ...
            private:
                ...
                MessagePropertyInterceptor& operator=(
                    const MessagePropertyInterceptor&);

            public:
                /**
                 * Constructor, accepts the Message that will be used to store
                 * JMS reserved property values, and the PrimitiveMap to get and
                 * set the rest to.
                 *
                 * @param message - The Message to store reserved property data
                 * in
                 ...
                 * @return The value for the named property.
                 */
                virtual unsigned char getByteProperty(
                 ...
                 * @return The value for the named property.
                 */
                virtual std::string getStringProperty(
                    const std::string& name) const;
