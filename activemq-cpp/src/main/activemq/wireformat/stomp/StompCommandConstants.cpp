...
const std::string StompCommandConstants::HEADER_CONTENTLENGTH =
    "content-length";
...
const std::string StompCommandConstants::HEADER_CORRELATIONID =
    "correlation-id";
...
const std::string StompCommandConstants::HEADER_DISPATCH_ASYNC =
    "activemq.dispatchAsync";
const std::string StompCommandConstants::HEADER_EXCLUSIVE =
    "activemq.exclusive";
const std::string StompCommandConstants::HEADER_MAXPENDINGMSGLIMIT =
    "activemq.maximumPendingMessageLimit";
const std::string StompCommandConstants::HEADER_NOLOCAL = "activemq.noLocal";
const std::string StompCommandConstants::HEADER_PREFETCHSIZE =
    "activemq.prefetchSize";
const std::string StompCommandConstants::HEADER_JMSPRIORITY = "priority";
const std::string StompCommandConstants::HEADER_CONSUMERPRIORITY =
    "activemq.priority";
const std::string StompCommandConstants::HEADER_RETROACTIVE =
    "activemq.retroactive";
const std::string StompCommandConstants::HEADER_SUBSCRIPTIONNAME =
    "activemq.subscriptionName";
const std::string StompCommandConstants::HEADER_OLDSUBSCRIPTIONNAME =
    "activemq.subcriptionName";
...
const std::string StompCommandConstants::HEADER_REDELIVERYCOUNT =
    "redelivery_count";
...
const std::string StompCommandConstants::HEADER_TRANSFORMATION =
    "transformation";
const std::string StompCommandConstants::HEADER_TRANSFORMATION_ERROR =
