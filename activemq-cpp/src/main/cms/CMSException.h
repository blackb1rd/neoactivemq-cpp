...
public:
    ...
    /**
     * Overloads the std::exception what() function to return the cause of the
     * exception
     *
     ...
     *
     * This method passes on ownership of the contained cause exception pointer
     * to the clone.  This method is mainly useful to the CMS provider.
     *
...
private:
     ...
     * assigned to one another so this method is hidden.
     *
     * @param other
