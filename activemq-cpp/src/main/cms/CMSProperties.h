...
public:
    ...
    /**
     * Returns the current count of all the Properties that are currently stored
    ...
    /**
     * Returns a vector containing all the names of the properties currently
     * stored in the Properties object.
     *
     * @return an STL std::vector<std::string> with all the currently stored
     * property names.
     */
