...
public:
    ...
    /**
     * The maximum number of bytes which will be copied into the array that is
     * passed to getBranchQualifier().
     */
...
public:
    ...
    /**
     * Gets the transaction branch qualifier component of the XID.  The value of
     * this Xid's branch qualifier is copied into the buffer provided.  If the
     * size of the provided buffer is not large enough to accommodate the branch
     * qualifier then no copy is performed and the method returns -1.
     *
     * @param buffer
     ...
     *
     * @throws XAException if the size parameter is less than zero or buffer is
     * NULL.
     */
     ...
     * Xid's transaction id is copied into the buffer provided.  If the size of
     * the provided buffer is not large enough to accommodate the transaction id
     * then no copy is performed and the method returns -1.
     *
     * @param buffer
