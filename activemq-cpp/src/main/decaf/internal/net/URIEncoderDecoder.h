...
namespace internal
{
    namespace net
    {
        ...
        public:
            ...
            /**
             * Validate a string by checking if it contains any characters other
             * than:
             *
             * 1. letters ('a'..'z', 'A'..'Z')
             * 2. numbers ('0'..'9')
             * 3. characters in the legalset parameter
             * 4. characters that are not ISO Control or are not ISO Space
             * characters)
             *
             ...
             * @throws URISyntaxException if the uri string is not well formed.
             */
            static void validateSimple(const std::string& s,
                                       const std::string& legal);

            /**
             * All characters except letters ('a'..'z', 'A'..'Z') and numbers
             * ('0'..'9') and legal characters are converted into their
             * hexidecimal value prepended by '%'. <p> For example: '#' -> %23
             * <p>
             * Other characters, which are chars that are not US-ASCII, and are
             * not ISO Control or are not ISO Space chars, are preserved.
             * @param s - the string to be converted
             * @param legal - the characters allowed to be preserved in the
             * string s
