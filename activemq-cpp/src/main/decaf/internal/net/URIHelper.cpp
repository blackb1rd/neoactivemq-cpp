...
URIType URIHelper::parseURI(const std::string& uri, bool forceServer)
{
        ...
        (index3 >= index || index3 == std::string::npos))
    {
        ...
        if (result.getScheme() == "")
        {
            throw URISyntaxException(__FILE__,
                                     __LINE__,
                                     uri,
        ...
        if (result.getSchemeSpecificPart() == "")
        {
            throw URISyntaxException(__FILE__,
                                     __LINE__,
                                     uri,
                                     "Scheme specific part is invalid..",
                                     (int)index + 1);
        }
    }
    else
         ...
         result.getSchemeSpecificPart().at(0) == '/'))
    {
        ...
        if (temp.size() >= 2 && temp.at(0) == '/' && temp.at(1) == '/')
        {
            ...
            else
            {
                ...
                if (result.getAuthority() == "" && result.getQuery() == "" &&
                    result.getFragment() == "")
                {
...
////////////////////////////////////////////////////////////////////////////////
void URIHelper::validateScheme(const std::string& uri,
                               ...
                               int                index)
{
    ...
    if (!Character::isLetter(scheme.at(0)))
    {
        throw URISyntaxException(__FILE__,
                                 __LINE__,
                                 uri,
                                 "Schema must start with a Letter.",
                                 (int)index);
    }
...
////////////////////////////////////////////////////////////////////////////////
void URIHelper::validateSsp(const std::string& uri,
...
////////////////////////////////////////////////////////////////////////////////
void URIHelper::validateAuthority(const std::string& uri,
...
////////////////////////////////////////////////////////////////////////////////
void URIHelper::validatePath(const std::string& uri,
...
////////////////////////////////////////////////////////////////////////////////
void URIHelper::validateQuery(const std::string& uri,
...
////////////////////////////////////////////////////////////////////////////////
void URIHelper::validateFragment(const std::string& uri,
...
////////////////////////////////////////////////////////////////////////////////
URIType URIHelper::parseAuthority(bool               forceServer,
                                  const std::string& authority)
{
    try
    {
        ...
        if (index != std::string::npos)
        {
            ...
            temp      = temp.substr(index + 1,
                               std::string::npos);  // host[:port] is left
            hostindex = index + 1;
        }
        ...
        if (index != std::string::npos &&
            (endindex < index || endindex == std::string::npos))
        {
            ...
            {  // port part is not empty
                try
                {
                    tempPort = Integer::parseInt(
                        temp.substr(index + 1, std::string::npos));
                    if (tempPort < 0)
                    {
                        if (forceServer)
                        {
...
////////////////////////////////////////////////////////////////////////////////
void URIHelper::validateUserinfo(const std::string& uri,
    ...
    try
    {
        if (host.at(0) == '[')
        {
            ...
            if (!isValidIP6Address(host))
            {
                throw URISyntaxException(__FILE__,
                                         __LINE__,
                                         host,
                                         "Host IPv6 address is not valid");
            }
            ...
            host.find(']') != std::string::npos)
        {
            throw URISyntaxException(__FILE__,
                                     __LINE__,
                                     host,
                                     "Unexpected '[' or ']' found in address");
        }
        ...
        if (forceServer)
        {
            throw URISyntaxException(__FILE__,
                                     __LINE__,
                                     host,
                                     "Host IPv4 address is not valid");
        }
    ...
    for (std::size_t i = 0; i < length; i++)
    {
        ...
        switch (c)
        {
            ...
            case '.':
                ...
                if (numberOfColons == 7 && ipAddress.at(0 + offset) != ':' &&
