...
namespace internal
{
    namespace net
    {
        ...
        /**
         * Helper class used by the URI classes in encoding and decoding of
         * URI's.
         */
        ...
        public:
            /**
             * Setup the URIHelper with values assigned to the various fields
             * that are used in the validation process.  The defaults are
             * overridden by these values.
             *
             * @param unreserved - characters not reserved for use.
             * @param punct - allowable punctuation symbols.
             * @param reserved - characters not allowed for general use in the
             * URI.
             ...
             * @throws URISyntaxException if forceServer is true and the URI is
             * invalid.
             */
             ...
             */
            void validateScheme(const std::string& uri,
             ...
             * @throw URISyntaxException if the fragment has errors.
             */
            void validateSsp(const std::string& uri,
                             const std::string& ssp,
                             std::size_t        index);

            /**
             * Validate that the URI Authority Segment contains no invalid
             * encodings.
             * @param uri - the full uri.
             ...
             * @throw URISyntaxException if the fragment has errors.
             */
            void validateAuthority(const std::string& uri,
             ...
             * @throw URISyntaxException if the fragment has errors.
             */
            void validatePath(const std::string& uri,
                              const std::string& path,
                              std::size_t        index);

            /**
             * Validate that the URI Query Segment contains no invalid
             * encodings.
             * @param uri - the full uri.
             ...
             * @throw URISyntaxException if the fragment has errors.
             */
            void validateQuery(const std::string& uri,
             ...
             * @throw URISyntaxException if the fragment has errors.
             */
            void validateFragment(const std::string& uri,
             ...
             * forceServer is false assume this is a registry based uri, and
             * just return leaving the host, port and user-info fields
             * undefined. <p> and there are some error cases where
             * URISyntaxException is thrown regardless of the forceServer
             * parameter e.g. mal-formed ipv6 address <p>
             * @param forceServer
             * @param authority
             * @return a URIType instance containing the parsed data.
             * @throw URISyntaxException
             */
            URIType parseAuthority(bool               forceServer,
                                   const std::string& authority);
             ...
             * @param index - index into the URI string where the data is
             * located.
             * @return true if valid
             * @throw URISyntaxException if an error occurs
             */
            void validateUserinfo(const std::string& uri,
                                  const std::string& userinfo,
                                  std::size_t        index);

            /**
             * distinguish between IPv4, IPv6, domain name and validate it based
             * on its type
             * @param forceServer - true if the forceServer mode should be
             * active.
             * @param host - Host string to validate.
             * @return true if the host value if a valid domain name.
             * @throws URISyntaxException if the host is invalid and forceServer
             * is true.
             */
            ...
            /**
             * Determines if the given address is valid according to the IPv6
             * spec.
