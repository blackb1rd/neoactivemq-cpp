...
namespace internal
{
    namespace net
    {
        ...
        public:
            ...
            /**
             * Gets if the URI is valid, meaning that the source has been set
             * and parsed and all relevant data fields have been set.
            ...
            /**
             * Sets if the URI is valid, meaning that the source has been set
             * and parsed and all relevant data fields have been set.
            ...
            /**
             * Gets the computed hashCode for this URIType or return -1 if non
             * is set
             *
             ...
             *
             * @param hashCode
             *      The new hash code that's been computed for this URIType
             * instance.
             */
