...
////////////////////////////////////////////////////////////////////////////////
void OpenSSLServerSocket::setEnabledCipherSuites(
...
////////////////////////////////////////////////////////////////////////////////
void OpenSSLServerSocket::setEnabledProtocols(
...
Socket* OpenSSLServerSocket::accept()
{
    try
    {
        std::unique_ptr<OpenSSLSocket> socket(
            new OpenSSLSocket(this->parameters->clone()));
