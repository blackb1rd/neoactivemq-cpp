...
namespace internal
{
    namespace nio
    {
        ...
        public:
             ...
             * and vice versa. The new buffer's capacity will be array length,
             * its position will be offset, its limit will be offset + length,
             * and its mark will be undefined. Its backing array will be the
             ...
             * undefined. Its backing array will be the given array, and its
            ...
            /**
             * Allocates a new char buffer whose position will be zero its limit
             * will be its capacity and its mark is not set.
             *
             * @param capacity
             *      The internal buffer's capacity.
             ...
             * @return a new CharBuffer that is backed by buffer, caller owns.
             */
            static decaf::nio::CharBuffer* createCharBuffer(
                std::vector<char>& buffer);

            /**
             * Allocates a new double buffer whose position will be zero its
             * limit will be its capacity and its mark is not set.
             *
             * @param capacity
             *      The internal buffer's capacity.
             *
             ...
             * @return a new DoubleBuffer that is backed by buffer, caller owns.
             */
            static decaf::nio::DoubleBuffer* createDoubleBuffer(
                std::vector<double>& buffer);

            /**
             * Allocates a new float buffer whose position will be zero its
             * limit will be its capacity and its mark is not set.
             *
             * @param capacity
             *      The internal buffer's capacity.
             ...
             * @return a new FloatBuffer that is backed by buffer, caller owns.
             */
            static decaf::nio::FloatBuffer* createFloatBuffer(
                std::vector<float>& buffer);

            /**
             * Allocates a new long long buffer whose position will be zero its
             * limit will be its capacity and its mark is not set.
             ...
             * @return a new LongBuffer that is backed by buffer, caller owns.
             */
            static decaf::nio::LongBuffer* createLongBuffer(
                std::vector<long long>& buffer);

            /**
             * Allocates a new int buffer whose position will be zero its limit
             * will be its capacity and its mark is not set.
             *
             * @param capacity
             *      The internal buffer's capacity.
             ...
             */
            static decaf::nio::IntBuffer* createIntBuffer(
                std::vector<int>& buffer);

            /**
             * Allocates a new short buffer whose position will be zero its
             * limit will be its capacity and its mark is not set.
             *
             * @param capacity
             *      The internal buffer's capacity.
             ...
             * @return a new DoubleBuffer that is backed by buffer, caller owns.
             */
            static decaf::nio::ShortBuffer* createShortBuffer(
