...
///////////////////////////////////////////////////////////////////////////////
CharArrayBuffer::CharArrayBuffer(char* array,
                                 int   size,
                                 int   offset,
                                 int   length,
                                 bool  readOnly)
...
///////////////////////////////////////////////////////////////////////////////
CharArrayBuffer::CharArrayBuffer(const Pointer<ByteArrayAdapter>& array,
                                 int                              offset,
                                 int                              length,
                                 bool                             readOnly)
    : CharBuffer(length),
    ...
    try
    {
        if (!this->hasArray())
        {
            throw activemq::exceptions::UnsupportedOperationException(
                __FILE__,
                __LINE__,
                "CharArrayBuffer::array() - This Buffer has no backing "
                "array.");
        }
    ...
    try
    {
        if (!this->hasArray())
        {
            throw activemq::exceptions::UnsupportedOperationException(
                __FILE__,
                __LINE__,
                "CharArrayBuffer::arrayOffset() - This Buffer has no backing "
                "array.");
        }
        ...
        if (!this->hasRemaining())
        {
            throw activemq::exceptions::BufferUnderflowException(
                activemq::exceptions::buildSourceMessage(
                    __FILE__,
                    __LINE__,
                    "CharArrayBuffer::get - Not enough data to fill "
                    "request."));
        }
