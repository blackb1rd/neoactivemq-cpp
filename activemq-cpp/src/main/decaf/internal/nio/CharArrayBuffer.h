...
namespace internal
{
    namespace nio
    {
        ...
        public:
            /**
             * Creates a CharArrayBuffer object that has its backing array
            ...
            /**
             * Creates a CharArrayBuffer object that wraps the given array.  If
             ...
             * CharArrayBuffer will be that of the remaining capacity of the
             * passed buffer.
             *
             * @param array
            ...
            /**
             * Create a CharArrayBuffer that mirrors this one, meaning it shares
