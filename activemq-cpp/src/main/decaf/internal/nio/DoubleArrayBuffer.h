...
namespace internal
{
    namespace nio
    {
        ...
        public:
            /**
             * Creates a DoubleArrayBuffer object that has its backing array
             ...
             * DoubleArrayBuffer will be that of the remaining capacity of the
             * passed buffer.
             *
             * @param array
             ...
             */
            DoubleArrayBuffer(
                const decaf::lang::Pointer<ByteArrayAdapter>& array,
                int                                           offset,
                int                                           length,
                bool                                          readOnly = false);

            /**
             * Create a DoubleArrayBuffer that mirrors this one, meaning it
