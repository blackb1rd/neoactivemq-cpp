...
namespace internal
{
    namespace nio
    {
        ...
        public:
            /**
             * Creates a FloatArrayBuffer object that has its backing array
             ...
             * FloatArrayBuffer will be that of the remaining capacity of the
             * passed buffer.
             *
             * @param array
            ...
            /**
             * Create a FloatArrayBuffer that mirrors this one, meaning it
