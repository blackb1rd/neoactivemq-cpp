...
namespace internal
{
    namespace nio
    {
        ...
        public:
            ...
            /**
             * Creates a IntArrayBuffer object that wraps the given array.  If
             ...
             * IntArrayBuffer will be that of the remaining capacity of the
             * passed buffer.
             *
             * @param array
             ...
             * than array size.
             */
            IntArrayBuffer(const decaf::lang::Pointer<ByteArrayAdapter>& array,
                           int                                           offset,
                           int                                           length,
                           bool readOnly = false);

            /**
             * Create a IntArrayBuffer that mirrors this one, meaning it shares
