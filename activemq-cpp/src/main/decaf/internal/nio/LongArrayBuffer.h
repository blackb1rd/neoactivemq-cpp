...
namespace internal
{
    namespace nio
    {
        ...
        public:
            /**
             * Creates a IntArrayBuffer object that has its backing array
            ...
            /**
             * Creates a LongArrayBuffer object that wraps the given array.  If
             ...
             * capacity.
             */
            LongArrayBuffer(long long* array,
                            int        size,
                            int        offset,
                            int        length,
                            bool       readOnly = false);
             ...
             * LongArrayBuffer will be that of the remaining capacity of the
             * passed buffer.
             *
             * @param array
             ...
             * than array size.
             */
            LongArrayBuffer(const decaf::lang::Pointer<ByteArrayAdapter>& array,
                            int  offset,
                            int  length,
                            bool readOnly = false);

            /**
             * Create a LongArrayBuffer that mirrors this one, meaning it shares
