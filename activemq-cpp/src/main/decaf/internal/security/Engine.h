...
namespace internal
{
    namespace security
    {
         ...
         * of looking up a ProviderService in the Security Runtime, using
         * correct locking and exception handling so that the higher level
         * classes don't need to implement that logic over again.
         */
        ...
        public:
             ...
             *
             * @return the service class name of this engine, e.g.
             * MessageDigest.
             */
             ...
             * Security framework and should be deleted by the calling
            ...
            /**
             * Return a new instance of the SercuritySpi implementation that is
             * named by this engine's serviceName and the passed algorithmName.
             *
             * @return a new instance of the SecuritySpi provided by
             * serviceName.algorithmName
             */
            decaf::security::SecuritySpi* newInstance(
