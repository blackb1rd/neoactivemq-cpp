...
namespace internal
{
    namespace security
    {
        ...
        /**
         * Internal class used to manage Security related resources and hide
        ...
        public:
            ...
            /**
             * Gets a pointer to the Security Runtime's Lock object, this can be
             * used by Security layer APIs to synchronize around certain actions
             * such as adding a resource to the Security layer, etc.
             *
             * The pointer returned is owned by the Security runtime and should
        ...
        public:  // Static methods
            ...
            /**
             * Shutdown the Security layer and free any associated resources,
             * classes in the Decaf library that use the Security layer will now
             * fail if used after calling the shutdown method.
             */
