            ...
            namespace crypto
            {
                ...
                public:
                    ...
                    void update(const unsigned char* vinput, int inputLen)
                    {
                        ...
                        if ((count[0] += ((unsigned int)inputLen << 3)) <
                    ...
                    // MD4 finalization. Ends an MD4 message-digest operation,
                    // writing the the message digest and then reset.
                ...
                private:
                    // MD4 basic transformation. Transforms state based on
                    // block.
...
////////////////////////////////////////////////////////////////////////////////
void MD4MessageDigestSpi::engineUpdate(const unsigned char* input,
                                       int                  size,
                                       int                  offset,
                                       int                  length)
{
    ...
    {
        engineReset();
        throw DigestException(__FILE__,
                              __LINE__,
                              "Incorrect offset or length value.");
    }
...
////////////////////////////////////////////////////////////////////////////////
int MD4MessageDigestSpi::engineDigest(unsigned char* buffer,
                                      int            size,
                                      int            offset,
                                      int            length)
{
    ...
    if (size < engineGetDigestLength())
    {
        ...
        throw DigestException(__FILE__,
                              __LINE__,
                              "The value of size parameter is less than the "
    ...
    if (length < engineGetDigestLength())
    {
        ...
        throw DigestException(__FILE__,
                              __LINE__,
                              "The value of length parameter is less than the "
                              "actual digest length.");
    }
