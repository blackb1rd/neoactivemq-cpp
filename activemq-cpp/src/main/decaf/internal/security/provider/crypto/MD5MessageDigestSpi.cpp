...
MD5MessageDigestSpi::MD5MessageDigestSpi()
    : MessageDigestSpi(),
      impl(new MD5MessageDigestSpiImpl)
{
}
...
////////////////////////////////////////////////////////////////////////////////
void MD5MessageDigestSpi::engineUpdate(const unsigned char* input,
                                       int                  size,
                                       int                  offset,
                                       int                  length)
{
...
////////////////////////////////////////////////////////////////////////////////
int MD5MessageDigestSpi::engineDigest(unsigned char* buffer,
                                      int            size,
                                      int            offset,
                                      int            length)
{
