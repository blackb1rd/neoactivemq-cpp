        ...
        namespace provider
        {
            namespace crypto
            {
                ...
                private:
                    ...
                    static void maybeReverseBytes(unsigned int* buffer,
                                                  int           count)
                    {
                        int           i;
                ...
                public:
                    ...
                    void finalize(unsigned char digest[DECAF_SHA1_DIGESTSIZE])
                    {
                        ...
                        {
                            memset(((unsigned char*)data) + index,
                                   0,
                                   SHA_BLOCKSIZE - index);
                            maybeReverseBytes(data, SHA_BLOCKSIZE);
                            SHA1Transform(state, data);
...
SHA1MessageDigestSpi::SHA1MessageDigestSpi()
    : MessageDigestSpi(),
      impl(new SHA1MessageDigestSpiImpl)
{
}
...
////////////////////////////////////////////////////////////////////////////////
void SHA1MessageDigestSpi::engineUpdate(const unsigned char* input,
                                        int                  size,
                                        int                  offset,
                                        int                  length)
{
...
////////////////////////////////////////////////////////////////////////////////
int SHA1MessageDigestSpi::engineDigest(unsigned char* buffer,
                                       int            size,
                                       int            offset,
                                       int            length)
{
