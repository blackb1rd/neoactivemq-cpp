...
namespace internal
{
    namespace util
    {
        ...
        public:
             ...
             * @param exponentWidth - Width of the exponent for the type to
             * parse
             * @param mantissaWidth - Width of the mantissa for the type to
             * parse
             */
        ...
        private:
            ...
            /*
             * Sets the exponent variable to Long::MAX_VALUE or -Long::MAX_VALUE
             * if overflow or underflow happens.
            ...
            /*
             * The value is rounded up or down to the nearest infinitely precise
             * result. If the value is exactly halfway between two infinitely
             * precise results, then it should be rounded up to the nearest
             * infinitely precise even.
             */
            void round();

            /*
             * Returns the normalized significand after removing the leading
             * zeros.
             */
            std::string getNormalizedSignificand(
                const std::string& strIntegerPart,
                const std::string& strDecimalPart);

            /*
             * Calculates the offset between the normalized number and
             * unnormalized number. In a normalized representation, significand
             * is represented by the characters "0x1." followed by a lower-case
        ...
        private:
             ...
             */
            static std::string* getSegmentsFromHexString(
