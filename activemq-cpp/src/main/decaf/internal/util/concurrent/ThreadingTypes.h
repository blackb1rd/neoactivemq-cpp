...
#define DECAF_MAX_TLS_SLOTS 384
             ...
             * on any platform, the PlatformThread methods will handle calling
             * this method and providing it with its assigned arg.
             *
             * @param arg
             *      A void* that was given when the thread was started.
             */
            typedef PLATFORM_THREAD_CALLBACK_TYPE(
                PLATFORM_CALLING_CONV* threadMainMethod)(
                PLATFORM_THREAD_ENTRY_ARG);

            /**
             * The ThreadHandle contains one of these and it should be the
             * method that does the actual work for the thread.
             */
            ...
            struct ThreadHandle
            {
                ...
                ThreadHandle* joiningThread;  // The thread this thread is
                                              // currently joining (NULL if not
                                              // joining)
            };
            ...
            public:
                ...
                /**
                 * Called from timed wait condition methods to indicate if the
                 * timeout has occurred, allows this method to take other
                 * actions based on the timeout having occurred or not.
                 *
                 * By default this method just defers to the simple operator()
                 * method.
                 *
                 * @param timedOut
                 *      Indicates that the calling wait condition timed out or
                 * not.
                 */
                ...
                /**
                 * Called from non-timed wait conditions to determine if the
                 * condition necessary to complete the wait has occurred or not.
                 */
