...
void BufferedInputStream::close()
{
    try
    {
        ...
        // Clear the proxy to the buffer, but don't actually delete the buffer
        // yet since other methods holding onto the buffer while blocked.
...
////////////////////////////////////////////////////////////////////////////////
int BufferedInputStream::doReadArrayBounded(unsigned char* buffer,
                                            int            size,
                                            int            offset,
                                            int            length)
{
...
////////////////////////////////////////////////////////////////////////////////
int BufferedInputStream::bufferData(InputStream*    inputStream,
