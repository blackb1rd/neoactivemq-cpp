...
////////////////////////////////////////////////////////////////////////////////
int ByteArrayInputStream::doReadArrayBounded(unsigned char* buffer,
                                             int            size,
                                             int            offset,
                                             int            length)
{
    try
    {
        ...
        int copylen = this->count - this->pos < length ? this->count - this->pos
                                                       : length;
...
long long ByteArrayInputStream::skip(long long num)
{
    try
    {
        ...
        int temp  = this->pos;
        this->pos = this->count - this->pos < num ? this->count
                                                  : (int)(this->pos + num);
