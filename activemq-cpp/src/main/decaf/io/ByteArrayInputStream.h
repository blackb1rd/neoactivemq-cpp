...
namespace io
{
     ...
     * next byte to be supplied by the read method. The ByteArrayInputStream
     * never copies the supplied buffers, only points to them, therefore the
    ...
    private:
         ...
         * Elements buffer[0] through buffer[count-1] are the only bytes that
         * can ever be read from the stream; element buffer[pos] is the next
         * byte to be read.
         */
         ...
         * stream buffer. This value should always be nonnegative and not larger
         * than the length of buffer. It is one greater than the position of the
         * last byte within buffer that can ever be read from the input stream
         * buffer.
         */
        int count;
         ...
         * of count. The next byte to be read from the input stream buffer will
         * be buffer[pos].
         */
        int pos;
         ...
         * may be marked at another position within the buffer by the mark()
         * method. The current buffer position is set to this point by the
         * reset() method.
         *
         * If no mark has been set, then the value of mark is the offset passed
    ...
    public:
        /**
         * Creates an ByteArrayInputStream with an empty input buffer, the
         * buffer can be initialized with a call to setByteArray.
         */
        ...
        /**
         * Create an instance of the ByteArrayInputStream with the given buffer
         * as the source of input for all read operations.
         *
         * @param buffer
