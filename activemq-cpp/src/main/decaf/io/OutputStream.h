...
namespace io
{
    ...
    /**
     * Base interface for any class that wants to represent an output stream of
     * bytes.
     *
     * @since 1.0
     */
    ...
    public:
         ...
         *
         * The default implementation of this method calls the pure virtual
         * method doWriteByte which must be implemented by any subclass of the
         * OutputStream.
         *
         * @param c
        ...
        /**
         * Writes an array of bytes to the output stream.  The entire contents
         * of the given vector are written to the output stream.
         *
         * The default implementation of this method simply calls the
         * doWriteArray which writes the contents of the array using the
         * doWriteByte method repeatedly.  It is recommended that a subclass
         * override doWriteArray to provide more performant means of writing the
         * array.
         *
         * @param buffer
        ...
        /**
         * Writes an array of bytes to the output stream in order starting at
         * buffer[offset] and proceeding until the number of bytes specified by
         * the length argument are written or an error occurs.
         *
         * The default implementation of this method simply calls the
