...
namespace io
{
     ...
     * subclass must implement are read( char*, size_t, size_t ) and close().
    ...
    public:
         ...
         * preserving the mark. After reading this many characters, attempting
         * to reset the stream may fail.
         *
         * @throw IOException if an I/O error occurs, or the stream does not
         * support mark.
         */
         ...
         * character-input streams support the reset() operation, and some
        ...
        /**
         * Reads characters into an array, the method will attempt to read as
         * much data as the size of the array. This method will block until some
         * input is available, an I/O error occurs, or the end of the stream is
         * reached.
         *
         * @param buffer
         ...
         *
         * @return The number of bytes read or -1 if the end of stream is
         * reached.
         *
         * @throws IOException thrown if an I/O error occurs.
