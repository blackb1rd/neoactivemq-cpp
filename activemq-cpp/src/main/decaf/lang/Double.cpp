...
DECAF_API const double Double::POSITIVE_INFINITY =
    std::numeric_limits<double>::infinity();
DECAF_API const double Double::NEGATIVE_INFINITY =
    -std::numeric_limits<double>::infinity();
...
const long long Double::DOUBLE_NAN_BITS      = DOUBLE_EXPONENT_MASK |
