...
namespace lang
{
    ...
    public:
        ...
        /**
         * Returns an long long value with at most a single one-bit, in the
         * position of the highest-order ("leftmost") one-bit in the specified
         * int value. Returns zero if the specified value has no one-bits in its
         * two's complement binary representation, that is, if it is equal to
         * zero.
         * @param value - the long long to be inspected
         * @return an long long value with a single one-bit, in the position of
         ...
         * the specified long long value. Returns 64 if the specified value has
         * no one-bits in its two's complement representation, in other words if
         * it is equal to zero.
         *
         ...
         * ("leftmost") one-bit in the two's complement binary representation of
         * the specified long long value, or 64 if the value is equal to zero.
         */
         ...
         * of the specified long long value. Returns 64 if the specified value
         * has no one-bits in its two's complement representation, in other
         * words if it is equal to zero.
         * @param value - the int to be inspected
         * @return the number of zero bits following the lowest-order
         * ("rightmost") one-bit in the two's complement binary representation
         * of the specified long long value, or 64 if the value is equal to
         * zero.
         */
         ...
         *
         * Note that the characters LL or ULL are not permitted to appear at the
         ...
         * first argument is interpreted as representing a signed long in the
         * radix specified by the second argument, exactly as if the arguments
         * were given to the parseLong(std::string, int) method. The result is a
         * Long object that represents the long long value specified by the
         * string.
         * @param value - String to parse
         ...
         * two's complement binary representation of the specified long long
         * value.
         ...
         * of bits. (Bits shifted out of the left hand, or high-order, side
         ...
         * of bits. (Bits shifted out of the right hand, or low-order, side
         ...
         * is -1 if the specified value is negative; 0 if the specified value is
         ...
         * @return an long long formatted to the string value of the radix
         * given.
         */
        ...
        /**
         * Returns a string representation of the long long argument as an
         * unsigned long long in base 8.
         *
         * The unsigned long long value is the argument plus 2^32 if the
         * argument is negative; otherwise, it is equal to the argument. This
         * value is converted to a string of ASCII digits in octal (base 8) with
         * no extra leading 0s.
         *
        ...
        /**
         * Returns a string representation of the long long argument as an
         * unsigned long long in base 2.
         *
         * The unsigned long long value is the argument plus 2^32 if the
         * argument is negative; otherwise it is equal to the argument. This
         * value is converted to a string of ASCII digits in binary (base 2)
         * with no extra leading 0s. If the unsigned magnitude is zero, it is
         * represented by a single zero character '0'; otherwise, the first
         * character of the representation of the unsigned magnitude will not be
         * the zero character. The characters '0' and '1' are used as binary
         * digits.
         ...
         * The first argument is interpreted as representing a signed long long
         * in the radix specified by the second argument, exactly as if the
         * argument were given to the parseLong(String, int) method. The result
         * is a Long object that represents the long long value specified by the
         * string.
         *
         * @param value
    ...
    private:
        static long long parse(const String& value,
                               int           offset,
                               int           radix,
                               bool          negative);
    };
