...
namespace lang
{
    ...
    public:
        ...
        /**
         * Returns the absolute value of an long long value. If the argument is
         ...
         * expression: Float::intBitsToFloat( 0x7fffffff &
         ...
         *
         * In other words, the result is the same as the value of the
         * expression: Double::longBitsToDouble( 0x7fffffffffffffffULL &
         ...
         * Special case:
         *
         *  o If the argument is NaN or its absolute value is greater than 1,
         ...
         *
         *  o If the argument is NaN or its absolute value is greater than 1,
         * then the result is NaN. o If the argument is zero, then the result is
         ...
         * method computes the phase theta by computing an arc tangent of y/x in
         * the range of -pi to pi. Special cases:
         *
         *  o If either argument is NaN, then the result is NaN.
         *  o If the first argument is positive zero and the second argument is
         *    positive, or the first argument is positive and finite and the
         * second argument is positive infinity, then the result is positive
         * zero. o If the first argument is negative zero and the second
         * argument is positive, or the first argument is negative and finite
         * and the second argument is positive infinity, then the result is
         * negative zero. o If the first argument is positive zero and the
         * second argument is negative, or the first argument is positive and
         * finite and the second argument is negative infinity, then the result
         * is the double value closest to pi. o If the first argument is
         * negative zero and the second argument is negative, or the first
         * argument is negative and finite and the second argument is negative
         * infinity, then the result is the double value closest to -pi. o If
         * the first argument is positive and the second argument is positive
         *    zero or negative zero, or the first argument is positive infinity
         * and the second argument is finite, then the result is the double
         * value closest to pi/2. o If the first argument is negative and the
         * second argument is positive zero or negative zero, or the first
         * argument is negative infinity and the second argument is finite, then
         * the result is the double value closest to -pi/2. o If both arguments
         * are positive infinity, then the result is the double value closest to
         * pi/4. o If the first argument is positive infinity and the second
         * argument is negative infinity, then the result is the double value
         * closest to 3*pi/4. o If the first argument is negative infinity and
         * the second argument is positive infinity, then the result is the
         * double value closest to -pi/4. o If both arguments are negative
         ...
         * cbrt(-x) == -cbrt(x); that is, the cube root of a negative value is
         * the negative of the cube root of that value's magnitude. Special
         * cases:
         *
         *  o If the argument is NaN, then the result is NaN.
         *  o If the argument is infinite, then the result is an infinity with
         * the same sign as the argument. o If the argument is zero, then the
        ...
        /**
         * Returns the hyperbolic cosine of a double value. The hyperbolic
         * cosine of x is defined to be (ex + e-x)/2 where e is Euler's number.
         * Special cases:
         *
         *  o If the argument is NaN, then the result is NaN.
         ...
         * x is defined to be (ex - e-x)/2 where e is Euler's number. Special
         * cases:
         *
         *  o If the argument is NaN, then the result is NaN.
         *  o If the argument is infinite, then the result is an infinity with
         ...
         * infinity. o If the argument is positive zero or negative zero, then
         ...
         *
         *  o If the second argument is positive or negative zero, then the
         * result is 1.0. o If the second argument is 1.0, then the result is
         * the same as the first argument. o If the second argument is NaN, then
         * the result is NaN. o If the first argument is NaN and the second
         * argument is nonzero, then the result is NaN.
         *
         * @param base - the base
         ...
         * <code>decaf.lang.Short::MIN_VALUE</code>.  If the arguments have the
         ...
         * value closer to negative infinity. If the arguments have the same
         * value, the result is that same value. If either value is NaN, then
         * the result is NaN. Unlike the numerical comparison operators, this
         * method considers negative zero to be strictly smaller than positive
         * zero. If one argument is positive zero and the other is negative
         * zero, the result is negative zero.
         * @param a - an argument.
         * @param b - another argument.
         * @return the smaller of <code>a</code> and <code>b</code>.
         */
         ...
         * the result is NaN. Unlike the numerical comparison operators, this
         * method considers negative zero to be strictly smaller than positive
         * zero. If one argument is positive zero and the other negative zero,
         ...
         *   o If the argument is positive infinity, then the result is positive
         *     infinity.
         *   o If the argument is positive zero or negative zero, then the
         * result is negative infinity. o If the argument is equal to 10n for
        ...
        /**
         * Returns the natural logarithm of the sum of the argument and 1. Note
         * that for small values x, the result of log1p(x) is much closer to the
         * true result of ln(1 + x) than the floating-point evaluation of
         * log(1.0+x).
         *
         * Special cases:
         *
         ...
         *   o If the argument is positive infinity, then the result is positive
         *     infinity.
         *   o If the argument is negative one, then the result is negative
         * infinity. o If the argument is zero, then the result is a zero with
         * the same sign as the argument.
         *
         * @param value - the value to operate on
         ...
         *   o If the argument value is already equal to a mathematical integer,
         *     then the result is the same as the argument.
         *   o If the argument is NaN or an infinity or positive zero or
         * negative zero, then the result is the same as the argument. o If the
         * argument value is less than zero but greater than -1.0, then the
         * result is negative zero.
         *
         * Note that the value of Math.ceil(x) is exactly the value of
         * -Math.floor(-x).
         * @param value - the value to find the ceiling of
         * @return the smallest (closest to negative infinity) floating-point
         ...
         *
         *    o If the argument value is already equal to a mathematical
         * integer, then the result is the same as the argument. o If the
         * argument is NaN or an infinity or positive zero or negative zero,
         * then the result is the same as the argument.
         *
         * @param value - the value to find the floor of
         * @return the largest (closest to positive infinity) floating-point
         ...
         *   o If the argument is negative infinity or any value less than or
         * equal to the value of Integer::MIN_VALUE, the result is equal to the
         * value of Integer::MIN_VALUE. o If the argument is positive infinity
         * or any value greater than or equal to the value of
         * Integer::MAX_VALUE, the result is equal to the value of
         *     Integer::MAX_VALUE.
         *
         * @param value - the value to round
         * @return the value of the argument rounded to the nearest integral
         * value.
         */
        static int round(float value);

        /**
         * Returns the closest long long to the argument. The result is rounded
         * to an integer by adding 1/2, taking the floor of the result, and
         * casting the result to type long long. In other words, the result is
         * equal to the value of the expression:  (long long)Math.floor(a +
         * 0.5d)
         *
         *   o If the argument is NaN, the result is 0.
         *   o If the argument is negative infinity or any value less than or
         * equal to the value of Long::MIN_VALUE, the result is equal to the
         * value of Long::MIN_VALUE. o If the argument is positive infinity or
         * any value greater than or equal to the value of Long::MAX_VALUE, the
         * result is equal to the value of Long::MAX_VALUE.
         *
         * @param value - the value to round
         * @return the value of the argument rounded to the nearest integral
         * value.
         ...
         * integers are equally close to f1/f2, then n is the integer that is
         * even. If the remainder is zero, its sign is the same as the sign of
         * the first argument. Special cases:
         *
         *  o If either argument is NaN, or the first argument is infinite, or
         * the second argument is positive zero or negative zero, then the
         * result is NaN. o If the first argument is finite and the second
         * argument is infinite, then the result is the same as the first
         * argument.
         *
         ...
         * pseudorandom-number generator; This new pseudorandom-number generator
         * is used thereafter for all calls to this method and is used nowhere
         * else.
         *
         ...
         *  o If the argument is NaN, the result is NaN.
         *  o If the argument is positive infinity, then the result is positive
         * infinity. o If the argument is negative infinity, then the result is
         * positive zero.
         *
         ...
         *  o If the argument is positive infinity, then the result is positive
         * infinity. o If the argument is negative infinity, then the result is
         * -1.0. o If the argument is zero, then the result is a zero with the
         ...
         * @return the sqrt(x^2 + y^2) without intermediate overflow or
         * underflow
         */
         ...
         * zero, 1.0f if the argument is greater than zero, -1.0f if the
         * argument is less than zero.  Special Cases:
         *
         *  o If the argument is NaN, then the result is NaN.
         *  o If the argument is positive zero or negative zero, then the result
         * is the same as the argument.
         *
         * @param value - the floating-point value whose signum is to be
         * returned
        ...
        /**
         * Returns the size of an ulp of the argument. An ulp of a float value
         * is the positive distance between this floating-point value and the
         * float value next larger in magnitude. Note that for non-NaN x,
         * ulp(-x) == ulp(x). Special Cases:
         *
         *  o If the argument is NaN, then the result is NaN.
         *  o If the argument is positive or negative infinity, then the result
         * is positive infinity. o If the argument is positive or negative zero,
         * then the result is Float::MIN_VALUE. o If the argument is
         * ±Float::MAX_VALUE, then the result is equal to 2^104.
         *
         ...
         *  o If the argument is positive or negative infinity, then the result
         * is positive infinity. o If the argument is positive or negative zero,
         * then the result is Double::MIN_VALUE. o If the argument is
         * ±Float::MAX_VALUE, then the result is equal to 2^971.
         *
         * @param value - the floating-point value whose ulp is to be returned
         * @return the size of an ulp of the argument
         */
