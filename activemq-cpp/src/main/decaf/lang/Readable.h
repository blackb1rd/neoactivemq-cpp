...
namespace lang
{
    ...
    /**
     * A Readable is a source of characters. Characters from a Readable are made
     * available to callers of the read method via a CharBuffer.
     *
     * @since 1.0
     */
    ...
    public:
         ...
         *
         * @return The number of char values added to the buffer, or -1 if this
