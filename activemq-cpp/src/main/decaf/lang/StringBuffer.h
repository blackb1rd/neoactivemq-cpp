...
namespace lang
{
     ...
     * StringBuffer, increasing the length of the StringBuffer. Characters at
     * any position in the StringBuffer may be replaced, which does not affect
     ...
     * increased.
     *
     * StringBuffer objects are safe for use by multiple threads. The methods
