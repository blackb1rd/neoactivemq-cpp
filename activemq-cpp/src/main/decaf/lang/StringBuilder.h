...
namespace lang
{
     ...
     * Strings. This class is intended as a direct replacement of StringBuffer
     * for non-concurrent use; unlike StringBuffer this class is not
     * synchronized for thread safety.
     *
     * The majority of the modification methods on this class return a reference
     * to this StringBuilder, so that, like StringBuffers, they can be used in
     * chaining method calls together. For example:
     *
     *  StringBuilder("One should ").append("always strive ").append("to achieve
     * Harmony")}.
     *
     * @see CharSequence
     * @see Appendable
    ...
    public:
         ...
         *
         * @param source
         *      The String whose contents are to be copied into this
         * StringBuilder.
         */
    ...
    public:
        ...
        /**
         * Appends the string representation of the given object pointer.  If
         * the pointer is NULL then the value "null" is appended to this
         * StringBuilder.
         *
         * @param pointer
        ...
        /**
         * Appends the contents of the CharSequence into this buffer, if the
         * CharSequence pointer is NULL then this method appends the string
         * "null" to this Buffer.
         *
         * @param value
         ...
         * append.  If the given CharSequence pointer is NULL then this method
        ...
        /**
         * Removes the characters in a substring of this buffer. The substring
         * begins at the specified start and extends to the character at index
         * end - 1 or to the end of the sequence if end is greater than the
         * current length() value. If start is equal to end, no changes are
         * made.
         *
         * @param start
        ...
        /**
         * Deletes the char at the specified position in this buffer, length
         * decreases by one.
         *
         * @param index
         *      The index in this buffer where the character to delete is
         * located.
         *
         * @return a reference to this StringBuilder so that operations can be
         * chained.
        ...
        /**
         * Inserts the string representation of the given object pointer.  If
         * the pointer is NULL then the value "null" is inserted to this
         * StringBuilder.
         *
         * @param index
         ...
         * The contents of the buffer are shifted up by one from the given index
         * prior to insertion.
         *
         * @param index
         *      The position in the buffer to insert the char value.
        ...
        /**
         * Inserts the given boolean into the character buffer at the given
         * index.  The value is converted to a String in the same fashion as
         * calling String::valueOf(bool).
         *
         * @param index
         ...
         * The value is converted to a String in the same fashion as calling
        ...
        /**
         * Inserts the given long long into the character buffer at the given
         * index.  The value is converted to a String in the same fashion as
         * calling String::valueOf(long long).
         *
         * @param index
        ...
        /**
         * Inserts the given double into the character buffer at the given
         * index.  The value is converted to a String in the same fashion as
         * calling String::valueOf(double).
         *
         * @param index
        ...
        /**
         * Inserts the given C string into the character buffer at the given
         * index.
         *
         * @param index
         *      The position in the buffer to insert the char value.
        ...
        /**
         * Inserts the given String into the character buffer at the given
         * index.
         *
         * @param index
         *      The position in the buffer to insert the char value.
        ...
        /**
         * Inserts the given std::string into the character buffer at the given
         * index.
         *
         * @param index
         *      The position in the buffer to insert the char value.
        ...
        /**
         * Inserts the given C string into the character buffer at the given
         * index starting from the given offset into the string and copying up
         * to length chars from the string into this buffer.
         *
         * @param index
         *      The position in the buffer to insert the char value.
         * @param value
        ...
        /**
         * Inserts the given CharSequence into the character buffer at the given
         * index starting from the given offset into the string and copying up
         * to length chars from the string into this buffer.  If the
         * CharSequence pointer is NULL then this method inserts the string
         * "null" into this Buffer.
         *
         * @param index
         *      The position in the buffer to insert the char value.
         * @param value
