...
namespace lang
{
     ...
     * methods being invoked, their arguments and local variables. Each process
     * has at least one main Thread running when it is started; typically, there
     * are several others for housekeeping. The application might decide to
     * launch additional Threads for specific purposes.
     *
     ...
     * {@link #start()} method must be called to actually execute the new
     * Thread.
     *
     * Each Thread has an integer priority that basically determines the amount
     * of CPU time the Thread gets. It can be set using the {@link
    ...
    public:
        ...
        enum State
        {
            ...
            /**
             * A Thread that is waiting for another Thread to perform an action
             * up to a specified time interval is in this state.
             */
            TIMED_WAITING = 4,
    ...
    public:
        ...
        public:
             ...
             * exception, throwing and exception from this method will on most
             * systems result in a segmentation fault.
             */
            virtual void uncaughtException(const Thread*    thread,
    ...
    public:
         ...
         * generated name. When no name is given the name is automatically
         * generated and are of the form "Thread-"+n, where n is an integer.
         */
        Thread();

        /**
         * Constructs a new Thread with the given target Runnable task. This
         * constructor has the same effect as Thread( NULL, task, GIVEN_NAME ),
         * where GIVEN_NAME is a newly generated name.  When no name is given
         * the name is automatically generated and are of the form  "Thread-"+n,
         * where n is an integer.
         *
         * @param task the Runnable that this thread manages, if the task is
         * NULL the Thread's run method is used instead.
         */
        Thread(Runnable* task);

        /**
         * Constructs a new Thread with the given name. This constructor has the
         * same effect as Thread( NULL, NULL, GIVEN_NAME ), where GIVEN_NAME is
         * a newly generated name. When no name is given the name is
         * automatically generated and are of the form "Thread-"+n, where n is
         * an integer.
         *
         ...
         * This constructor has the same effect as Thread( NULL, task,
         * GIVEN_NAME ), where GIVEN_NAME is a newly generated name.  When no
         * name is given the name is automatically generated and are of the form
         ...
         *
         * @param task
         *      The Runnable that this thread manages, if the task is NULL the
         * Thread's run method is used instead.
         * @param name
        ...
        /**
         * Obtains the Thread Id of the current thread, this value is OS
         * specific but is guaranteed not to change for the lifetime of this
         * thread.
         *
        ...
        /**
         * Sets the current Thread's priority to the newly specified value.  The
         * given value must be within the range Thread::MIN_PRIORITY and
         * Thread::MAX_PRIORITY.
         *
         ...
         * an uncaught exception.
         *
         * @param handler the UncaightExceptionHandler to invoke when the Thread
        ...
        /**
         * Returns true if the Thread is alive, meaning it has been started and
         * has not yet died.
         *
        ...
        /**
         * Returns but does not clear the state of this Thread's interrupted
         * flag.
         *
    ...
    public:
        ...
        /**
         * Causes the currently executing thread to halt execution for the
         * specified number of milliseconds plus any additionally specified
         * nanoseconds given, subject to the precision and accuracy of system
        ...
        /**
         * Returns whether the thread has been interrupted and clears the
         * interrupted state such that a subsequent call will return false
         * unless an interrupt occurs between the two calls.
         *
         * @return true if the thread was interrupted, false otherwise.
         */
         ...
         * to an uncaught exception, this handler is used only if there is no
         * other handler defined for the Thread.  This method will return NULL
         * if no handler has ever been set, or the handler is cleared via a call
         * to the setDefaultUncaughtExceptionHandler method will NULL as the
         * value of the handler argument.
         *
         * @return a pointer to the default UncaughtExceptionHandler for all
         * Threads.
         */
         ...
         *
         * @param handler
         *      The UncaightExceptionHandler to invoke when a Thread terminates
         * due to an uncaught exception, passing NULL clears this value.
         */
    ...
    private:
        ...
        void initializeSelf(Runnable*          task,
