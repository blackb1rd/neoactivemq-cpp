...
namespace lang
{
    namespace exceptions
    {
        ...
        /*
         * Thrown when an operation is requested, but the array index would
         * result in an access that is outside the bounds of the array.
         *
         * @since 1.0
         */
        class DECAF_API ArrayIndexOutOfBoundsException
        ...
        public:
            ...
            /**
             * Create a new ArrayIndexOutOfBoundsException with the given index
             ...
             */
            ArrayIndexOutOfBoundsException(const char*           file,
