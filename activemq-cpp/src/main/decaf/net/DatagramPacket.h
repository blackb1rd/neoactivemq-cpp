...
namespace net
{
     ...
     *
     * Datagrams are sent in packets from machine to machine and can each be
     * routed differently and can arrive in any order.  Delivery of a packet is
     * not guaranteed.
     *
     * @since 1.0
     */
    ...
    public:
        /**
         * Creates a new DatagramPacket for use in receiving a packet of the
         * given length.
         *
         * @param bytes
        ...
        /**
         * Creates a new DatagramPacket for use in receiving a packet of the
         * given length starting at the specified offset into the buffer.
         *
         * @param bytes
         *      The array of bytes to hold the incoming datagram buffer.
         * @param size
        ...
        /**
         * Creates a new DatagramPacket for use in sending a packet of the given
         * length starting at the specified offset into the buffer to the
        ...
        /**
         * Creates a new DatagramPacket for use in sending a packet of the given
         * length to the specified host on the specified port.
         *
         * @param bytes
         *      The array of bytes to hold the outgoing datagram buffer.
         * @param size
        ...
        /**
         * Creates a new DatagramPacket for use in sending a packet of the given
         * length into the buffer to the specified socket address.
         *
         * @param bytes
         *      The array of bytes to hold the outgoing datagram buffer.
         * @param size
    ...
    public:
        /**
         * @return the IP address that this datagram packet is being sent to or
         * was received from.
         */
        ...
        /**
         * @return the port number that this datagram packet is being sent to or
         * was received from.
         */
        int getPort() const;
        ...
        /**
         * @return the offset of the data to be sent or the offset of the data
         * received.
         */
        int getOffset() const;

        /**
         * Sets the offset into the data buffer where data to sent is to be read
         * from or where the data that is received should start writing to.
         *
         * @param offset
        ...
        /**
         * @return the length of the data to be sent or the length of the data
         * received.
         */
        int getLength() const;

        /**
         * Set the length for this packet. The length of the packet is the
         * number of bytes from the packet's data buffer that will be sent, or
         * the number of bytes of the packet's data buffer that will be used for
         * receiving data. The length must be lesser or equal to the offset plus
        ...
        /**
         * @return the data buffer. The data received or the data to be sent
         * starts from the offset in the buffer, and continues for length bytes.
         */
         ...
         * DatagramPacket set to 0, and the length set to the size value
         * specified.
         *
         * @param buffer
