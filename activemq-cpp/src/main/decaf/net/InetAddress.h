...
namespace net
{
    ...
    protected:
        ...
        InetAddress(const std::string&   hostname,
    ...
    public:
        ...
        /**
         * Returns the Raw IP address in Network byte order.  The returned
         * address is a copy of the bytes contained in this InetAddress.
         *
         * @return and ArrayPointer containing the raw bytes of the network
         * address.
         */
         ...
         *
         * If a host name was set upon construction then that value is returned,
         * otherwise a reverse name lookup with be performed to attempt to get
         * the host name associated with the set IP Address.  If the host name
         * cannot be resolved the textual representation of the IP Address is
         * returned instead.
         *
        ...
        /**
         * Returns a string representation of the InetAddress in the form
         * 'hostname / ipaddress'
         *
        ...
        /**
         * Returns a newly allocated copy of this InetAddress.  The caller owns
         * the resulting copy and must delete it.
         *
         * @return a new InetAddress instance that is a copy of this one, caller
         * owns.
         */
        virtual InetAddress* clone() const;

    public:
        // Address Property Tests, override in the subclasses for correct
        // results
    ...
    public:
        ...
        /**
         * Given a raw IP Address in byte array form, create and return a new
         * InetAddress instance.
         *
         * An IPV4 address must be only four bytes in length and an IPV6 address
         * must be 16 bytes in length.
         *
         * @return a copy of an InetAddress that represents the given byte array
         * address.
         *
         * @throws UnknownHostException if the address array length is invalid.
         */
        static InetAddress getByAddress(const unsigned char* bytes,
                                        int                  numBytes);

        /**
         * Given a host name and IPAddress return a new InetAddress.  There is
         * no name service checking or address validation done on the provided
         * host name.  The host name can either be machine name or the text
         * based representation of the IP Address.
         *
         * An IPV4 address must be only four bytes in length and an IPV6 address
         * must be 16 bytes in length.
         *
         ...
         * @throws UnknownHostException if the address array length is invalid.
         */
        static InetAddress getByAddress(const std::string&   hostname,
                                        const unsigned char* bytes,
                                        int                  numBytes);

        /**
         * Gets an InetAddress that is the local host address.  If the localhost
         * value cannot be resolved than the InetAddress for Loopback is
         * returned.
         *
         * @return a new InetAddress object that contains the local host
         * address.
         *
         * @throws UnknownHostException if the address for local host is not
         * found.
         */
    ...
    protected:
        /**
         * Converts the bytes in an address array to an int starting from the
         * value start treating the start value as the high order byte.
         *
         * @param bytes
