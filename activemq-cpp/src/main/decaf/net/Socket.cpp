      ...
      outputShutdown(false)
{
    if (impl == NULL)
    {
        throw activemq::exceptions::NullPointerException(
            __FILE__,
            __LINE__,
            "SocketImpl pointer passed was Null.");
    }
}
      ...
      outputShutdown(false)
{
    if (address == NULL)
    {
        throw activemq::exceptions::NullPointerException(
            __FILE__,
            __LINE__,
            "The InetAddress to connect to cannot be NULL");
    }
    ...
    if (port < 0 || port > 65535)
    {
        throw activemq::exceptions::InvalidArgumentException(
            ...
            "Port specified is out of range: " + std::to_string(port));
    }
      ...
      outputShutdown(false)
{
    ...
    try
    {
        ...
        this->initSocketImpl(address->getHostAddress(),
                             port,
                             localAddress,
                             localPort);
    }
...
////////////////////////////////////////////////////////////////////////////////
void Socket::initSocketImpl(const std::string& host,
                            int                port,
                            const InetAddress* localAddress,
                            int                localPort)
{
...
void Socket::bind(const std::string& ipaddress, int port)
{
    ...
    if (isBound())
    {
        throw IOException(__FILE__, __LINE__, "The Socket is already bound.");
    }
...
void Socket::connect(const std::string& host, int port, int timeout)
{
    ...
    if (timeout < 0)
    {
        throw activemq::exceptions::InvalidArgumentException(
            std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": " +
            "Timeout value specified is invalid: " + std::to_string(timeout));
    }
    ...
    try
    {
        ...
        try
        {
            if (!isBound())
            {
                // Client sockets should bind to localhost, not INADDR_ANY
                // (0.0.0.0) Binding to 0.0.0.0 can require elevated permissions
                // on Windows
    ...
    try
    {
        if (isInputShutdown())
        {
            throw IOException(__FILE__,
                              __LINE__,
                              "Input was shutdown on this Socket.");
        }
...
OutputStream* Socket::getOutputStream()
{
    ...
    try
    {
        if (isOutputShutdown())
        {
            throw IOException(__FILE__,
                              __LINE__,
                              "Output was shutdown on this Socket.");
        }
...
void Socket::shutdownInput()
{
    if (isInputShutdown())
    {
        throw IOException(__FILE__,
                          __LINE__,
                          "Socket input has already been shutdown.");
    }
...
void Socket::shutdownOutput()
{
    if (isOutputShutdown())
    {
        throw IOException(__FILE__,
                          __LINE__,
                          "Socket output has already been shutdown.");
    }
...
void Socket::setSoLinger(bool state, int timeout)
{
    ...
    try
    {
        ...
        if (state && timeout < 0)
        {
            throw activemq::exceptions::InvalidArgumentException(
                std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": " +
                "Timeout value passed is invalid: " + std::to_string(timeout));
        }
...
bool Socket::getKeepAlive() const
{
    ...
    {
        ensureCreated();
        return this->impl->getOption(SocketOptions::SOCKET_OPTION_KEEPALIVE) ==
                       0
                   ? false
                   : true;
    }
...
void Socket::setKeepAlive(bool keepAlive)
{
    ...
    {
        ensureCreated();
        this->impl->setOption(SocketOptions::SOCKET_OPTION_KEEPALIVE,
                              keepAlive ? 1 : 0);
    }
    DECAF_CATCH_RETHROW(SocketException)
    DECAF_CATCH_EXCEPTION_CONVERT(Exception, SocketException)
...
bool Socket::getReuseAddress() const
{
    ...
    {
        ensureCreated();
        return this->impl->getOption(SocketOptions::SOCKET_OPTION_REUSEADDR) ==
                       0
                   ? false
                   : true;
    }
...
void Socket::setReuseAddress(bool reuse)
{
    ...
    {
        ensureCreated();
        this->impl->setOption(SocketOptions::SOCKET_OPTION_REUSEADDR,
                              reuse ? 1 : 0);
    }
    DECAF_CATCH_RETHROW(SocketException)
    DECAF_CATCH_EXCEPTION_CONVERT(Exception, SocketException)
...
bool Socket::getTcpNoDelay() const
{
    ...
    {
        ensureCreated();
        return this->impl->getOption(
                   SocketOptions::SOCKET_OPTION_TCP_NODELAY) == 0
                   ? false
                   : true;
    }
    DECAF_CATCH_RETHROW(SocketException)
...
void Socket::setTcpNoDelay(bool value)
{
    ...
    {
        ensureCreated();
        this->impl->setOption(SocketOptions::SOCKET_OPTION_TCP_NODELAY,
                              value ? 1 : 0);
    }
    DECAF_CATCH_RETHROW(SocketException)
    DECAF_CATCH_EXCEPTION_CONVERT(Exception, SocketException)
...
void Socket::setTrafficClass(int value)
{
    ...
    if (value < 0 || value > 255)
    {
        throw activemq::exceptions::InvalidArgumentException(
            std::string(__FILE__) + ":" + std::to_string(__LINE__) + ": " +
            "Value of the Traffic class option was invalid: " +
            std::to_string(value));
    }
...
bool Socket::getOOBInline() const
{
    ...
    {
        ensureCreated();
        return this->impl->getOption(SocketOptions::SOCKET_OPTION_OOBINLINE) ==
                       0
                   ? false
                   : true;
    }
...
void Socket::setOOBInline(bool value)
{
    ...
    {
        ensureCreated();
        this->impl->setOption(SocketOptions::SOCKET_OPTION_OOBINLINE,
                              value ? 1 : 0);
    }
    DECAF_CATCH_RETHROW(SocketException)
    DECAF_CATCH_EXCEPTION_CONVERT(Exception, SocketException)
...
void Socket::setSocketImplFactory(SocketImplFactory* factory)
{
    if (Socket::factory != NULL)
    {
        throw SocketException(__FILE__,
                              __LINE__,
                              "A SocketInplFactory was already set.");
    }
