...
namespace net
{
    ...
    public:
        /**
         * Creates an unconnected Socket using the set SocketImplFactory or if
         * non is set than the default SockImpl type is created.
         */
        Socket();

        /**
         * Creates a Socket wrapping the provided SocketImpl instance, this
         * Socket is considered unconnected.  The Socket class takes ownership
         * of this SocketImpl pointer and will delete it when the Socket class
         * is destroyed.
         *
         * @param impl
        ...
        /**
         * Creates a new Socket instance and connects it to the given address
         * and port.  If there is a SocketImplFactory set then the SokcetImpl is
         * created using the factory otherwise the default Socket implementation
         * is used.
         *
         ...
         * and port.  If there is a SocketImplFactory set then the SokcetImpl is
         * created using the factory otherwise the default Socket implementation
         * is used.  The Socket will also bind to the local address and port
         * specified.
         *
         * @param address
         *      The address to connect to.
        ...
        /**
         * Creates a new Socket instance and connects it to the given host and
         * port.  If there is a SocketImplFactory set then the SokcetImpl is
         * created using the factory otherwise the default Socket implementation
         * is used.
         *
         * If the host parameter is empty then the loop back address is used.
         *
         * @param host
         *      The host name or IP address to connect to, empty string means
         * loopback.
         * @param port
         *      The port number to connect to [0...65535]
         *
        ...
        /**
         * Binds this Socket to the given local address and port.  If the
         * SocketAddress value is NULL then the Socket will be bound to an
        ...
        /**
         * Closes the Socket.  Once closed a Socket cannot be connected or
         * otherwise operated upon, a new Socket instance must be created.
         *
         ...
         * @throws IllegalArguementException if the timeout value is negative or
         * the endpoint is invalid.
         */
        virtual void connect(const std::string& host, int port);

        /**
         * Connects to the specified destination, with a specified timeout
         * value.  If a connection to the remote host is not established within
         * the specified timeout interval than an SocketTimeoutException is
         * thrown.  A timeout value of zero is treated as an inifinite timeout.
         *
         * @param host
         *      The host name or IP address of the remote host to connect to.
         * @param port
         *      The port on the remote host to connect to.
         * @param timeout
         *      The number of Milliseconds to wait before treating the
         * connection as failed.
         *
         * @throws IOException Thrown if a failure occurred in the connect.
         * @throws SocketTimeoutException if the timeout for connection is
         * exceeded.
         * @throws IllegalArguementException if the timeout value is negative or
         * the endpoint is invalid.
         */
        ...
        /**
         * Gets the InputStream for this socket if its connected.  The pointer
         * returned is the property of the associated Socket and should not be
         * deleted by the caller.
         *
         * When the returned InputStream is performing a blocking operation and
         * the underlying connection is closed or otherwise broker the read
         * calls will normally throw an exception to indicate the failure.
         *
         * Closing the InputStream will also close the underlying Socket.
         *
         * @return The InputStream for this socket.
         *
         * @throws IOException if an error occurs during creation of the
         * InputStream, also if the Socket is not connected or the input has
         * been shutdown previously.
         */
        virtual decaf::io::InputStream* getInputStream();

        /**
         * Gets the OutputStream for this socket if it is connected.  The
         * pointer returned is the property of the Socket instance and should
         ...
         *
         * @throws IOException if an error occurs during the creation of this
         * OutputStream, or if the Socket is closed or the output has been
         * shutdown previously.
         */
         ...
         *
         * @return the port on the remote host the socket is connected to, or 0
         * if not connected.
         */
        int getPort() const;
         ...
         *
         * @return the local port the socket was bound to, or -1 if the socket
         * is not bound.
         */
        ...
        /**
         * Shuts down the InputStream for this socket essentially marking it as
         * EOF.  The stream returns EOF for any calls to read after this method
         * has been called.
         *
        ...
        /**
         * Shuts down the OutputStream for this socket, any data already written
         * to the socket will be sent, any further calls to OuputStream::write
        ...
        /**
         * Gets the linger time for the socket, SO_LINGER.  A return value of -1
        ...
        /**
         * Sets the linger time (SO_LINGER) using a specified time value, this
         * limits of this value are platform specific.
         *
         * @param state
        ...
        /**
         * Gets the send buffer size for this socket, SO_SNDBUF, this value is
         * used by the platform socket to buffer data written to the socket.
         *
         ...
         *
         * @param size
         *      The number of bytes to set the send buffer to, must be larger
         * than zero.
         *
         * @throws SocketException if the operation fails.
         * @throws IllegalArgumentException if the value is zero or negative.
        ...
        /**
         * Sets the Status of the TCP_NODELAY param for this socket., this
         * setting is used to disable or enable Nagle's algorithm on the Socket.
         *
         * @param value
        ...
        /**
         * Gets the Traffic Class setting for this Socket, sometimes referred to
         * as Type of Service setting.  This setting is dependent on the
         * underlying network implementation for the platform this Socket runs
         * on and is not guaranteed to have any effect.
         *
         * Refer to your platforms network documentation regarding support for
         * this setting.
         *
        ...
        /**
         * Sets the value of the OOBINLINE for this socket, by default this
         * option is disabled.  If enabled the urgent data is read inline on the
         * Socket's InputStream, no notification is give.
         *
         * @return true if OOBINLINE is enabled, false otherwise.
         *
         * @throws SocketException if an error is encountered while performing
         ...
         *
         * @param data
         *      The value to write as urgent data, only the lower eight bits are
         * sent.
         *
         * @throws IOException if an I/O error occurs while performing this
         * operation.
    ...
    public:
        /**
         * Sets the instance of a SocketImplFactory that the Socket class should
         * use when new instances of this class are created.  This method is
         * only allowed to be used once during the lifetime of the application.
         *
         * @param factory
         *      The instance of a SocketImplFactory to use when new Socket
         * objects are created.
         *
         * @throws IOException if an I/O error occurs while performing this
         * operation.
    ...
    protected:
        // Flags the Socket instance as created, bound and connected when its
        // connected via a ServerSocket accept call.
        void accepted();

        // Sets up a connected socket for the constructors that take connection
        // arguments.
        void initSocketImpl(const std::string& address,
                            int                port,
                            const InetAddress* localAddress,
                            int                localPort);
