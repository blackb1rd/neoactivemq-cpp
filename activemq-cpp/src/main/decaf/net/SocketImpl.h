...
namespace net
{
    ...
    public:
        /**
         * Creates the underlying platform Socket data structures which allows
         * for Socket options to be applied.  The created socket is in an
         * unconnected state.
         *
         ...
         * @throws IOException if an I/O error occurs while attempting this
         * operation.
         * @throws SocketException if an error occurs while performing an Accept
         * on the socket.
         * @throws SocketTimeoutException if the accept call times out due to
         * SO_TIMEOUT being set.
         */
         ...
         * @param timeout
         *      Time in milliseconds to wait for a connection, 0 indicates
         * forever.
         *
         * @throws IOException if an I/O error occurs while attempting this
         * operation.
         * @throws SocketTimeoutException if the connect call times out due to
         * timeout being set.
         * @throws IllegalArguementException if a parameter has an illegal
         * value.
         */
        ...
        /**
         * Binds this Socket instance to the local ip address and port number
         * given.
         *
         * @param ipaddress
         ...
         * request to connect) to the count argument. If a connection indication
        ...
        /**
         * Gets the number of bytes that can be read from the Socket without
         * blocking.
         *
         * @return the number of bytes that can be read from the Socket without
         * blocking.
         *
         * @throws IOException if an I/O error occurs while attempting this
         * operation.
         ...
         * sent to this socket is acknowledged and then silently discarded. If
         * you read from a socket input stream after invoking shutdownInput() on
        ...
        /**
         * Gets the FileDescriptor for this Socket, the Object is owned by this
         * Socket and should not be deleted by the caller.
         *
        ...
        /**
         * Gets the value of the local Inet address the Socket is bound to if
         * bound, otherwise return the InetAddress ANY value "0.0.0.0".
         *
        ...
        /**
         * @return true if this SocketImpl supports sending Urgent Data.  The
