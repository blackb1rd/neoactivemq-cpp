...
namespace net
{
     ...
     * object, such as a query to a database or to a search engine. More
     ...
     * host machine is both protocol dependent and host dependent. The
     * information normally resides in a file, but it could be generated on the
     * fly. This component of the URL is called the path component.
     *
     ...
     * specified, the default port for the protocol is used instead. For
     * example, the default port for http is 80. An alternative port could be
     * specified as:
     *
     ...
     * Addresses in URLs. The Literal IPv6 address format also supports
     * scope_ids. The syntax and usage of scope_ids is described here.
     *
     ...
     * Relative URLs are frequently used within HTML pages. For example, if the
     * contents of the URL:
     *
     ...
     * optional fragment is not inherited.
     *
     * The URL class does not itself encode or decode any URL components
     * according to the escaping mechanism defined in RFC2396. It is the
     * responsibility of the caller to encode any fields, which need to be
     * escaped prior to calling URL, and also to decode any escaped fields, that
     * are returned from URL. Furthermore, because URL has no knowledge of URL
     * escaping, it does not recognise equivalence between the encoded or
     * decoded form of the same URL. For example, the two URLs:
     *
     ...
     *
     * The URLEncoder and URLDecoder classes can also be used, but only for HTML
     * form encoding, which is not the same as the encoding scheme defined in
     * RFC2396.
     *
     * @since 1.0
     */
    ...
    public:
         ...
         * constructor with a empty first argument.
         *
         * @param url
         ...
         * context authority and path. If the authority component is absent in
         * the spec then the authority of the new URL will be inherited from the
         * context.
         *
         * If the spec's path component begins with a slash character "/" then
         * the path is treated as absolute and the spec path replaces the
         * context path.
         *
         * Otherwise, the path is treated as a relative path and is appended to
         * the context path, as described in RFC2396. Also, in this case, the
         * path is canonicalized through the removal of directory changes made
         * by occurrences of ".." and ".".
         *
         ...
         *      if the given string spec could not be parsed as a URL or an
         * invalid protocol has been found.
         */
        URL(const URL& context, const decaf::lang::String& spec);

        /**
         * Creates a URL object from the specified protocol, host, port number,
         * file, and handler. Specifying a port number of -1 indicates that the
         * URL should use the default port for the protocol. Specifying a
         * handler of null indicates that the URL should use a default stream
         * handler for the protocol, as outlined for:
         *
         *    URL(const String&, const String&, int, const String&)
         *
         * If a URLStreamHandler instance is provided then this class will take
         * ownership of the object and delete at a later time.
         *
         * @param protocol
         ...
         */
        URL(const decaf::lang::String& protocol,
        ...
        /**
         * Creates a URL from the specified protocol name, host name, and file
        ...
        /**
         * Creates a new URL instance using the given arguments. The URL uses
         * the specified port instead of the default port for the given
         * protocol.
         *
         * @param protocol
         *      the name of the protocol to use.
         ...
         *
         * If a stream handler instance is passed then this object takes
         * ownership of it and will destroy the resources when no longer needed.
         *
         * @param context
         *      the URL which is used as the context.
         * @param spec
    ...
    public:
         ...
         * both host names equal to empty string.
         *
         * Since hosts comparison requires name resolution, this operation is a
         * blocking operation.
         *
         * @return true if this URL is considered equal to the given URL
         * instance.
         */
         ...
         * URL. If the URL scheme or the URLStreamHandler for the URL do not
         * define a default port number, then -1 is returned.
         *
         ...
         * same as getPath(), plus the concatenation of the value of getQuery(),
         * if any. If there is no query portion, this method and getPath() will
        ...
        /**
         * Creates an integer hash code for this URL which is used in hash based
         * collections.
         *
         * The hash code is based upon all the URL components relevant for URL
         * comparison which means that the host resolution may cause this
         * operation to block.
         *
         ...
         *
         * If for the URL's protocol (such as HTTP), there exists a public,
         ...
         * java.net, the connection returned will be of that subclass. For
         * example, for HTTP an HttpURLConnection will be returned, and for JAR
         * a JarURLConnection will be returned.
         *
        ...
        /**
         * Same basic functionality as openConnection() is provided here, except
         * that the connection will be made through the specified proxy;
         * Protocol handlers that do not support proxing will ignore the proxy
        ...
        /**
         * Shortcut method to opens a connection to this URL and fetch an
        ...
        /**
         * Compares this URL to the other ignoring the fragment portion to
         * determine if both reference the same remote object.
         *
        ...
        /**
         * Constructs a string representation of this URL, by calling the
    ...
    public:
         ...
         * protocol handler from a protocol name.  The provided factory becomes
         * the property of this runtime and will be deleted at shutdown.
         *
         * @param factory
         *      the desired factory.
         *
    ...
    private:
        ...
        /**
         * Returns the URLStreamHandler configured for this URL, used to
         * validate that the operations performed by a protocol handler are only
         * done on its own URL.
         */
        URLStreamHandler* getURLStreamHandler() const;

    private:
        void initialize(const URL*                 context,
                        const decaf::lang::String& theSpec,
                        URLStreamHandler*          handler);
        void initialize(const decaf::lang::String& protocol,
                        const decaf::lang::String& host,
                        int                        port,
                        const decaf::lang::String& file,
                        URLStreamHandler*          handler);
