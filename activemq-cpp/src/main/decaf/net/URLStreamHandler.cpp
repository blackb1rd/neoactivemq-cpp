...
////////////////////////////////////////////////////////////////////////////////
void URLStreamHandler::parseURL(URL&          url,
                                const String& spec,
                                int           start,
                                int           limit)
{
    ...
    if (spec.regionMatches(start, "//", 0, 2))
    {
        ...
        int userInfoEnd =
            URLUtils::findFirstOf(spec, "@", authorityStart, fileStart);
        int hostStart;
        ...
        int hostEnd =
            URLUtils::findFirstOf(spec, ":", colonSearchFrom, fileStart);
