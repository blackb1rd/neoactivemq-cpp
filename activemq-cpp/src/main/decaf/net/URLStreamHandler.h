...
namespace net
{
     ...
     * connection for a particular protocol type, such as http, ftp, or https
     * etc.
     *
     ...
     * handler is automatically created from a registered stream handler
     * factory.
     *
     * @since 1.0
     */
    ...
    protected:
        /**
         * Establishes a new connection to the resource specified by the given
         * URL. Since different protocols also have unique ways of connecting,
         * it must be overridden by the subclass.
         *
         * @param url
         *      the URL to the resource where a connection has to be opened.
         *
         * @return pointer to the opened URLConnection to the specified
         * resource.
         *
        ...
        /**
         * Establishes a new connection to the resource specified by the given
         * URL. The version uses a Proxy to establish the connection if proxying
         * is supported by the URLConnection implementation in use, otherwise
        ...
        /**
         * Provides the default equals calculation. May be overridden by
         * handlers for other protocols that have different requirements for
         * equals().
         *
         * @param source
        ...
        /**
         * Provides the default hashCode calculation. May be overridden by
         * handlers for other protocols that have different algorithms for
         ...
         *      The URL that is being compared to source.
         *
         * @return true if the two URL instances are considered to point to the
         * same host.
         */
         ...
         * having the same protocol, host, port, and path.
         *
         * @param source
         *      The URL class that is invoking this comparison.
         * @param other
         *      The URL that is being compared to source.
         *
         * @return true if the two URL instances are considered to be the same
         * file.
         */
        ...
        /**
         * Attempts to get the IP address of the host.  Based on DNS errors or
         * other conditions it's possible this method will return an empty
         * string.
         *
         * @param url
         *      The URL to construct the string from.
        ...
        /**
         * Returns the default port for a URL parsed by this handler. This
         * method should be overidden by handlers with knowledge of the default
         * port numbers as the default implementation simply returns -1.
         *
         ...
         * <p>
         *
         * The string is parsed in HTTP format. If the protocol has a different
         * URL format this method must be overridden.
         *
         * @param url
         ...
         */
        virtual void parseURL(URL&                       url,
                              const decaf::lang::String& spec,
                              int                        start,
                              int                        limit);

        /**
         * Sets the fields of the URL  This method is only intended to be used
         * by subclasses of URLStreamHandler so it is kept protected.
         *
         * @param protocol
