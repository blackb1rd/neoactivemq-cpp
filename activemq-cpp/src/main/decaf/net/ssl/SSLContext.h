...
namespace net
{
    namespace ssl
    {
        ...
        /**
         * Represents on implementation of the Secure Socket Layer for streaming
         * based sockets.
         *
         * This class servers a a source of factories to be used to create new
        ...
        public:
             ...
             *
             * The default instance of the SSLContext should be immediately
             * usable without any need for the client to initialize this
             * context.
             *
            ...
            /**
             * Sets the default SSLContext to be returned from future calls to
             * getDefault.
             *
             * The set SSLContext must be fully initialized and usable.  The
        ...
        public:
            ...
            /**
             * Returns an SocketFactory instance for use with this Context, the
             * SocketFactory is owned by the Context and should not be deleted
             * by the caller.
             *
            ...
            /**
             * Returns an ServerSocketFactory instance for use with this
             * Context, the ServerSocketFactory is owned by the Context and
