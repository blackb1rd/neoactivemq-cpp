...
namespace net
{
    ...
    namespace ssl
    {
        ...
        /**
         * Defines the interface that should be provided by an SSLContext
         * provider.
         *
         * @since 1.0
         */
        ...
        public:
            ...
            /**
             * Creates a returns a new SSLParameters instance that contains the
             * default settings for this Providers SSLContext.
             *
             * The returned SSLParameters instance is requires to have non-empty
             * values in its ciphersuites and protocols.
             *
            ...
            /**
             * Creates and returns a new SSLParameters instance that contains
             * the full set of supported parameters for this SSL Context.
             *
             * The returned SSLParameters instance is requires to have non-empty
             * values in its ciphersuites and protocols.
             *
            ...
            /**
             * Returns a SocketFactory instance that can be used to create new
             * SSLSocket objects.
             *
             * The SocketFactory is owned by the Service Provider and should not
            ...
            /**
             * Returns a ServerSocketFactory instance that can be used to create
             * new SSLServerSocket objects.
             *
             * The ServerSocketFactory is owned by the Service Provider and
