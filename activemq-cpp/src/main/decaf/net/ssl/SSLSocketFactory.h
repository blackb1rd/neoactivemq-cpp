...
namespace net
{
    namespace ssl
    {
        ...
        /**
         * Factory class interface for a SocketFactory that can create SSLSocket
         * objects.
         *
         * @since 1.0
         */
        ...
        public:
            ...
            /**
             * Returns the current default SSL SocketFactory, the factory is
             * returned as a pointer however the caller does not own this
             * pointer and should not delete it.
             *
             * This method returns SSLContext::getDefault()->getSocketFactory().
             * If that call fails, a non-functional factory is returned.
             *
             ...
             * Unless a different list is enabled, handshaking on an SSL
             * connection will use one of these cipher suites. The minimum
             * quality of service for these defaults requires confidentiality
             * protection and server authentication (that is, no anonymous
             * cipher suites).
             *
             * @return an STL vector containing the list of cipher suites
             * enabled by default.
             *
             ...
             * use on an SSL connection. Normally, only a subset of these will
             ...
             * for those defaults. Such cipher suites are useful in specialized
             * applications.
             *
             * @return an STL vector containing the list of supported cipher
             * suites.
             *
             ...
             * named host, at the given port. This constructor can be used when
             * tunneling SSL through a proxy or when negotiating the use of SSL
             * over an existing socket. The host and port refer to the logical
             * peer destination. This socket is configured using the socket
             ...
             * @param autoClose
             *      Should the layered over Socket be closed when the topmost
             * socket is closed.
             *
             ...
             */
            virtual Socket* createSocket(Socket*     socket,
                                         std::string host,
                                         int         port,
                                         bool        autoClose) = 0;
