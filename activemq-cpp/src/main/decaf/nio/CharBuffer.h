...
namespace nio
{
     ...
     * characters; o Relative bulk get methods that transfer contiguous
     * sequences of characters from this buffer into an array; and o Relative
     * bulk put methods that transfer contiguous sequences of characters from a
     * character array, a string, or some other character buffer into this
     * buffer. o Methods for compacting, duplicating, and slicing a character
     * buffer.
     *
     * Character buffers can be created either by allocation, which allocates
     * space for the buffer's content, by wrapping an existing character array
     ...
     * example in the regular-expression package decaf.util.regex.
     *
    ...
    public:
         ...
         * buffer If value is Null the the string "null" is appended to the
         * buffer.
         *
         * @param value
         *      The CharSequence to append.
        ...
        /**
         * Returns the character array that backs this buffer  (optional
         * operation).
         *
         ...
         * position.
         *
         * @param index - The index of the character to be read relative to
         * position
         *
        ...
        /**
         * Relative get method. Reads the character at this buffer's current
         ...
         *
         * This method transfers chars from this buffer into the given
         * destination array. If there are fewer chars remaining in the buffer
         ...
         *
         * Otherwise, this method copies length chars from this buffer into the
        ...
        /**
         * This method transfers the chars remaining in the given source buffer
         * into this buffer. If there are more chars remaining in the source
         * buffer than in this buffer, that is, if src.remaining() >
         * remaining(), then no chars are transferred and a
         * BufferOverflowException is thrown.
         *
         * Otherwise, this method copies n = src.remaining() chars from the
        ...
        /**
         * This method transfers chars into this buffer from the given source
         * array. If there are more chars to be copied from the array than
         * remain in this buffer, that is, if length > remaining(), then no
         * chars are transferred and a BufferOverflowException is thrown.
         *
        ...
        /**
         * This method transfers the entire content of the given source char
         ...
         * buffer. If there are more characters to be copied from the string
         * than remain in this buffer, that is, if end - start > remaining(),
         * then no characters are transferred and a BufferOverflowException is
         * thrown.
         * @return a reference to this buffer
         *
         * Otherwise, this method copies n = end - start characters from the
         * given string into this buffer, starting at the given start index and
         * at the current position of this buffer. The position of this buffer
         ...
         * into this buffer. An invocation of this method of the form dst.put(s)
        ...
        /**
         * Creates a new character buffer that represents the specified
         * subsequence of this buffer, relative to the current position.
         *
         * The new buffer will share this buffer's content; that is, if the
         * content of this buffer is mutable then modifications to one buffer
         * will cause the other to be modified. The new buffer's capacity will
         * be that of this buffer, its position will be position() + start, and
         * its limit will be position() + end. The new Buffer will be read-only
         * if, and only if, this buffer is read-only.
         *
         * @param start
         ...
         * following the last character in the subsequence; must be no smaller
         * than start and no larger than remaining().
         *
        ...
        /**
         * Creates a new CharBuffer whose content is a shared subsequence of
    ...
    public:  // Statics
         ...
         *
         * The new buffer will be backed by the given char array; modifications
         ...
         * given character sequence. The buffer's capacity will be csq.length(),
         * its position will be start, its limit will be end, and its mark will
         * be undefined.
         *
         * @param csq
         ...
         * non-negative and no larger than csq.length(). The new buffer's
         * position will be set to this value.
         * @param end
         *      The index of the character following the last character to be
         * used; must be no smaller than start and no larger than the size of
         * the sequence.
         *
         ...
         */
        // TODO
        //        static CharBuffer* wrap( lang::CharSequence* csq, int start,
        //        int end );
