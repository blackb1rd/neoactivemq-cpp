...
namespace nio
{
     ...
     * doubles; o Relative bulk get methods that transfer contiguous sequences
     * of doubles from this buffer into an array; and o Relative bulk put
     * methods that transfer contiguous sequences of doubles from a double array
     * or some other double buffer into this buffer o Methods for compacting,
     * duplicating, and slicing a double buffer.
     *
     * Double buffers can be created either by allocation, which allocates space
     * for the buffer's content, by wrapping an existing double array into a
    ...
    protected:
        /**
         * Creates a DoubleBuffer object that has its backing array allocated
    ...
    public:
        ...
        /**
         * Returns the double array that backs this buffer  (optional
         * operation).
         *
         ...
         *
         * This method transfers values from this buffer into the given
         ...
         *
         * @throws BufferUnderflowException iIf there are fewer than length
         ...
         * destination array. If there are fewer doubles remaining in the buffer
         ...
         *
         * Otherwise, this method copies length doubles from this buffer into
         * the given array, starting at the current position of this buffer and
         ...
         * source buffer than in this buffer, that is, if src.remaining() >
         * remaining(), then no doubles are transferred and a
         * BufferOverflowException is thrown.
         *
         * Otherwise, this method copies n = src.remaining() doubles from the
        ...
        /**
         * This method transfers doubles into this buffer from the given source
         * array. If there are more doubles to be copied from the array than
         * remain in this buffer, that is, if length > remaining(), then no
         * doubles are transferred and a BufferOverflowException is thrown.
         *
        ...
        /**
         * This method transfers the entire content of the given source doubles
        ...
        /**
         * Writes the given doubles into this buffer at the current position,
        ...
        /**
         * Creates a new DoubleBuffer whose content is a shared subsequence of
    ...
    public:  // Statics
         ...
         *
         * The new buffer will be backed by the given double array; that is,
