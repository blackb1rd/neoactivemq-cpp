...
namespace nio
{
     ...
     * floats; o Relative bulk get methods that transfer contiguous sequences of
     * floats from this buffer into an array; and o Relative bulk put methods
     * that transfer contiguous sequences of floats from a float array or some
     * other float buffer into this buffer o Methods for compacting,
     * duplicating, and slicing a float buffer.
     *
     * Double buffers can be created either by allocation, which allocates space
     * for the buffer's content, by wrapping an existing float array into a
    ...
    protected:
        /**
         * Creates a FloatBuffer object that has its backing array allocated
    ...
    public:
         ...
         * floats remaining in this buffer
         */
         ...
         * destination array. If there are fewer floats remaining in the buffer
         ...
         *
         * Otherwise, this method copies length floats from this buffer into the
        ...
        /**
         * This method transfers the floats remaining in the given source buffer
         * into this buffer. If there are more floats remaining in the source
         * buffer than in this buffer, that is, if src.remaining() >
         * remaining(), then no floats are transferred and a
         * BufferOverflowException is thrown.
         *
         * Otherwise, this method copies n = src.remaining() floats from the
         ...
         * this buffer for the remaining floats in the source buffer
        ...
        /**
         * This method transfers floats into this buffer from the given source
         * array. If there are more floats to be copied from the array than
         * remain in this buffer, that is, if length > remaining(), then no
         * floats are transferred and a BufferOverflowException is thrown.
         *
        ...
        /**
         * This method transfers the entire content of the given source floats
        ...
        /**
         * Writes the given floats into this buffer at the current position, and
        ...
        /**
         * Creates a new FloatBuffer whose content is a shared subsequence of
    ...
    public:  // Statics
         ...
         *
         * The new buffer will be backed by the given float array; modifications
         ...
         * @param buffer - The vector that will back the new buffer, the vector
         * must have been sized to the desired size already by calling
         * vector.resize( N ).
         * @return a new FloatBuffer that is backed by buffer, caller owns.
         */
