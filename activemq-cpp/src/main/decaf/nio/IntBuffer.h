...
namespace nio
{
     ...
     * ints; o Relative bulk get methods that transfer contiguous sequences of
     * ints from this buffer into an array; and o Relative bulk put methods that
     * transfer contiguous sequences of ints from a int array or some other int
     * buffer into this buffer o Methods for compacting, duplicating, and
     * slicing a int buffer.
     *
     * Double buffers can be created either by allocation, which allocates space
     * for the buffer's content, by wrapping an existing int array into a
    ...
    protected:
        /**
         * Creates a IntBuffer object that has its backing array allocated
    ...
    public:
         ...
         * destination array. If there are fewer ints remaining in the buffer
         ...
         *
         * Otherwise, this method copies length ints from this buffer into the
        ...
        /**
         * This method transfers the ints remaining in the given source buffer
         * into this buffer. If there are more ints remaining in the source
         ...
         * this buffer for the remaining ints in the source buffer.
        ...
        /**
         * This method transfers ints into this buffer from the given source
         * array. If there are more ints to be copied from the array than remain
         * in this buffer, that is, if length > remaining(), then no ints are
        ...
        /**
         * This method transfers the entire content of the given source ints
        ...
        /**
         * Writes the given integer into this buffer at the current position,
         ...
         * @return a reference to this buffer.
         *
         * @throws IndexOutOfBoundsException - If index greater than the
         * buffer's limit minus the size of the type being written, or the index
         * is negative.
         * @throws ReadOnlyBufferException - If this buffer is read-only.
         */
         ...
         * visible in the new buffer, and vice versa; the two buffers' position,
    ...
    public:  // Statics
         ...
         *
         * The new buffer will be backed by the given int array; that is,
         ...
         *
         * The new buffer will be backed by the given int array; modifications
