...
namespace nio
{
     ...
     * long longs; o Relative bulk get methods that transfer contiguous
     * sequences of long longs from this buffer long longo an array; and o
     * Relative bulk put methods that transfer contiguous sequences of long
     * longs from a long long array or some other long long buffer long longo
     * this buffer o Methods for compacting, duplicating, and slicing a long
     * long buffer.
     *
     * Double buffers can be created either by allocation, which allocates space
     * for the buffer's content, by wrapping an existing long long array long
     * longo a buffer, or by creating a view of an existing byte buffer
     *
    ...
    protected:
        /**
         * Creates a LongBuffer object that has its backing array allocated long
         * longernally and is then owned and deleted when this object is
         * deleted.  The array is initially created with all elements
         * initialized to zero.
         *
         * @param capacity
    ...
    public:
        ...
        /**
         * Returns the long long array that backs this buffer  (optional
         * operation).
         *
         ...
         * ensure that this buffer has an accessible backing array.
         *
         * @return The offset long longo the backing array where index zero
         * starts.
         *
         * @throws ReadOnlyBufferException if this Buffer is read only.
         * @throws UnsupportedOperationException if the underlying store has no
        ...
        /**
         * Creates a new, read-only long long buffer that shares this buffer's
         * content.
         *
         ...
         *
         * @return The new, read-only long long buffer which the caller then
         * owns.
         */
        ...
        /**
         * Relative get method. Reads the value at this buffer's current
         ...
         *
         * This method transfers values from this buffer long longo the given
         ...
         * Relative bulk get method.
         *
         * This method transfers long longs from this buffer long longo the
         * given destination array. If there are fewer long longs remaining in
         ...
         *
         * Otherwise, this method copies length long longs from this buffer long
         * longo the given array, starting at the current position of this
        ...
        /**
         * Tells whether or not this buffer is backed by an accessible long long
        ...
        /**
         * This method transfers the long longs remaining in the given source
         * buffer long longo this buffer. If there are more long longs remaining
         * in the source buffer than in this buffer, that is, if src.remaining()
         * > remaining(), then no long longs are transferred and a
         * BufferOverflowException is thrown.
         *
         * Otherwise, this method copies n = src.remaining() long longs from the
         * given buffer long longo this buffer, starting at each buffer's
        ...
        /**
         * This method transfers long longs long longo this buffer from the
         * given source array. If there are more long longs to be copied from
         * the array than remain in this buffer, that is, if length >
         * remaining(), then no long longs are transferred and a
         * BufferOverflowException is thrown.
         *
         * Otherwise, this method copies length bytes from the given array long
         * longo this buffer, starting at the given offset in the array and at
         * the current position of this buffer. The position of this buffer is
        ...
        /**
         * This method transfers the entire content of the given source long
         * longs array long longo this buffer.  This is the same as calling put(
        ...
        /**
         * Writes the given long longs long longo this buffer at the current
         * position, and then increments the position.
         *
         * @param value
        ...
        /**
         * Writes the given long longs long longo this buffer at the given
         * index.
         *
         * @param index
        ...
        /**
         * Creates a new LongBuffer whose content is a shared subsequence of
    ...
    public:  // Statics
         ...
         * capacity, and its mark will be undefined. It will have a backing
         * array, and its array offset will be zero.
         *
         * @param capacity
         ...
         *
         * The new buffer will be backed by the given long long array; that is,
         ...
         *
         * The new buffer will be backed by the given long long array;
         * modifications to the buffer will cause the array to be modified and
         * vice versa. The new buffer's capacity and limit will be
         * buffer.size(), its position will be zero, and its mark will be
         * undefined. Its backing array will be the given array, and its array
         * offset will be zero.
         *
         * @param buffer
         *      The vector that will back the new buffer, the vector must have
