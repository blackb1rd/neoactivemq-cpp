...
namespace nio
{
     ...
     * shorts; o Relative bulk get methods that transfer contiguous sequences of
     * shorts from this buffer into an array; and o Relative bulk put methods
     * that transfer contiguous sequences of shorts from a short array or some
     * other short buffer into this buffer o Methods for compacting,
     * duplicating, and slicing a short buffer.
     *
     * Double buffers can be created either by allocation, which allocates space
     * for the buffer's content, by wrapping an existing short array into a
    ...
    protected:
        /**
         * Creates a ShortBuffer object that has its backing array allocated
    ...
    public:
         ...
         * shorts remaining in this buffer.
         */
         ...
         * destination array. If there are fewer shorts remaining in the buffer
         ...
         *
         * Otherwise, this method copies length shorts from this buffer into the
         ...
         * into this buffer. If there are more shorts remaining in the source
         * buffer than in this buffer, that is, if src.remaining() >
         * remaining(), then no shorts are transferred and a
         * BufferOverflowException is thrown.
         *
         * Otherwise, this method copies n = src.remaining() shorts from the
         ...
         * this buffer for the remaining shorts in the source buffer.
         ...
         * array. If there are more shorts to be copied from the array than
         * remain in this buffer, that is, if length > remaining(), then no
         * shorts are transferred and a BufferOverflowException is thrown.
         *
        ...
        /**
         * This method transfers the entire content of the given source shorts
        ...
        /**
         * Writes the given shorts into this buffer at the current position, and
        ...
        /**
         * Creates a new ShortBuffer whose content is a shared subsequence of
    ...
    public:  // Statics
         ...
         *
         * The new buffer will be backed by the given short array; modifications
