...
namespace security
{
    ...
    /**
     * This class represents a "provider" for the Decaf Security API, where a
     * provider implements some or all parts of Decaf Security. Services that a
     * provider may implement include:
     *
