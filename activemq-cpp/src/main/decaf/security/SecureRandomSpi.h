...
namespace security
{
    ...
    /**
     * Interface class used by Security Service Providers to implement a source
    ...
    public:
        ...
        /**
         * Reseed the Random Number Generator, the value given supplements the
         * previous seed value if any instead of replacing it.
         *
         * @param seed
        ...
        /**
         * Generates the number of random bytes specified by the size parameter
         * and write them to the passed bytes array.  The array must have
         * already been allocated and be of the correct size to prevent
         * segmentation faults.
         *
         * @param bytes
        ...
        /**
         * Generates a new set of seed bytes, the returned value may be used to
         * seed another Random Number Generator.  The caller owns the returned
         * array and must delete it.
         *
         * @param numBytes
         *      The number of bytes that should be generated for the new seed
         * array.
         */
