...
namespace util
{
    ...
    public:
         ...
         * operation). The collection will be empty after this method returns.
         *
         * This implementation iterates over this collection, removing each
         * element using the Iterator.remove operation. Most implementations
         ...
         * contained in this collection. If all elements are so contained true
         ...
         * and if each element contained in the Collection given is equal to an
         ...
         *
         * The default implementation iterates over the contents of the given
         * collection adding each to this collection after first calling this
         ...
         *
         * Note that this implementation will throw an
         * UnsupportedOperationException unless add is overridden (assuming the
         * specified collection is non-empty).
         */
         ...
         * if the iterator returned by this collection's iterator method does
         * not implement the remove method and this collection contains the
         * specified object.
         */
         ...
         * element returned by the iterator in turn to see if it's contained in
         * the specified collection. If it's so contained, it's removed from
         ...
         * This implementation iterates over this collection, checking each
         * element returned by the iterator in turn to see if it's contained in
         * the specified collection. If it's not so contained, it's removed from
         * this collection with the iterator's remove method.
         *
         * Note that this implementation will throw an
         * UnsupportedOperationException if the iterator returned by the
        ...
        /**
         * Answers an STL vector containing copies of all elements contained in
         * this Collection. All the elements in the array will not be referenced
         * by the collection. The elements in the returned array will be sorted
         * to the same order as those returned by the iterator of this
         * collection itself if the collection guarantees the order.
         *
