...
namespace util
{
     ...
     * this class and provide an implementation for the entrySet method, which
     * returns a set-view of the map's mappings. Typically, the returned set
     * will, in turn, be implemented atop AbstractSet. This set should not
     * support the add or remove methods, and its iterator should not support
     * the remove method.
     *
