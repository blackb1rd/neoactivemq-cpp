...
namespace util
{
     ...
     * method Queue. offer(E) which does not permit insertion of null elements,
     * along with methods Queue. peek(), Queue.poll(), Collection.size(), and a
     * Collection.iterator() supporting Iterator.remove(). Typically, additional
     * methods will be overridden as well. If these requirements cannot be met,
     * consider instead subclassing AbstractCollection.
     *
     * @since 1.0
     */
    template <typename E>
