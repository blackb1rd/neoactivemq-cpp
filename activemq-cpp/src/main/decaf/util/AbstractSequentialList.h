...
namespace util
{
     ...
     * data (such as an array), AbstractList should be used in preference to
     * this class.
     *
     ...
     * should additionally implement the list iterator's remove and add methods.
     *
    ...
    public:
         ...
         * indexed element (with listIterator(index)). Then, it gets the element
        ...
        virtual E get(int index) const
        {
            try
            {
                std::unique_ptr<ListIterator<E>> iter(
         ...
         *
         * This implementation first gets a list iterator pointing to the
         * indexed element (with listIterator(index)). Then, it gets the current
         * element using ListIterator.next and replaces it with
         * ListIterator.set.
         */
         ...
         *
         * This implementation first gets a list iterator pointing to the
         * indexed element (with listIterator(index)). Then, it inserts the
         * specified element with ListIterator.add.
         */
         ...
         * and a list iterator over this list pointing to the indexed element
         * (with listIterator(index)). Then, it iterates over the specified
         * collection, inserting the elements obtained from the iterator into
         * this list, one at a time, using ListIterator.add (to skip over the
         * added element).
         */
         ...
         *
         * This implementation first gets a list iterator pointing to the
         * indexed element (with listIterator(index)). Then, it removes the
         * element with ListIterator.remove.
         */
