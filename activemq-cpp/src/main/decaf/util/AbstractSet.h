...
namespace util
{
     ...
     * instance, the add method must not permit addition of multiple instances
    ...
    public:
         ...
         * the specified collection, by invoking the size method on each. If
         * this set has fewer elements, then the implementation iterates over
         * this set, checking each element returned by the iterator in turn to
         * see if it is contained in the specified collection. If it is so
         * contained, it is removed from this set with the iterator's remove
         * method. If the specified collection has fewer elements, then the
         * implementation iterates over the specified collection, removing from
         * this set each element returned by the iterator, using this set's
         * remove method.
         *
