...
namespace util
{
    ...
    public:
         ...
         * the minimum capacity argument.  If the capacity is already greater
         * than or equal to the minimum capacity argument then the array is left
         * unchanged.
         *
        ...
        void ensureCapacity(int minimumCapacity)
        {
            ...
            if (this->curSize > 0)
            {
                decaf::lang::System::arraycopy(this->elements,
                                               this->head,
                                               newElements,
                                               0,
                                               this->curSize);
         ...
         * This compacts the internal array to save storage space used by this
         * ArrayList.
         */
        void trimToSize()
        {
