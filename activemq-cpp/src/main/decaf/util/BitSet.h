...
namespace util
{
     ...
     * set, or cleared. One BitSet may be used to modify the contents of another
     * BitSet through logical AND, logical inclusive OR, and logical exclusive
     * OR operations.
     *
     ...
     *
     * A BitSet is not safe for multi-threaded use without external
     * synchronization.
     *
     * @since 1.0
     */
    ...
    public:
         ...
         * bits are initially false.  If the bitCount is not a multiple of 64
         * then the count is rounded to the next closest multiple of 64.
         *
         * @param bitCount
    ...
    public:
         ...
         * bit set is modified so that a bit in it has the value true if and
        ...
        /**
         * Clears all of the bits in this BitSet whose corresponding bit is set
         ...
         * if and only if is a Bitset object that has exactly the same set of
         * bits set to true as this bit set. That is, for every nonnegative int
         * index k,
         *
         ...
         * true if the bit with the given index is currently set in this BitSet;
         ...
         *
         * @return boolean indicating whether this BitSet intersects the
         * specified BitSet.
         */
        ...
        /**
         * Sets the bits from the specified fromIndex (inclusive) to the
         * specified toIndex (exclusive) to the value given.
         *
         * @param fromIndex
         *      The index (inclusive) to start at.
         * @param toIndex
         ...
         * represent bit values. The maximum element in the set is the size -
         * 1st element.
         *
         ...
         * are listed in order from lowest to highest, separated by
    ...
    private:
        ...
        /**
         * Gets the actual length of the BitSet bit array which is maintained in
         * a sometimes lazy fashion to avoid excessive array traversals.  The
         * actual length is the number of non-zero array elements in the
         * physical array used to back this BitSet.
         *
