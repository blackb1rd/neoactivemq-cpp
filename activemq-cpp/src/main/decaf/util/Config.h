...
/* config.h is generated by the ./configure script and it only used by unix like
 * systems. */
#include <config.h>
...
/**
 * Not using ./configure script and make system.. chances are your using the
 * native build tools of Windows or OS X to do this build
 */
#if defined(_WIN32)
