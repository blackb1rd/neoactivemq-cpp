...
namespace util
{
    ...
    /**
     * Base HashCode template, specializations are created from this to account
     * for the various native types.
     *
     * @since 1.0
     */
    template <typename T>
    ...
    struct HashCode<unsigned long long>
        : public HashCodeUnaryBase<unsigned long long>
    {
    ...
    struct HashCode<long long> : public HashCodeUnaryBase<long long>
    {
        ...
        {
            return (int)((unsigned long long)arg ^
    ...
    struct HashCode<double> : public HashCodeUnaryBase<double>
    {
        int operator()(double arg) const
        {
            ...
            return (int)((unsigned long long)value ^
    ...
    struct HashCode<const std::string>
        : public HashCodeUnaryBase<const std::string&>
    {
        int operator()(const std::string& arg) const
        {
            int h = 0;
    ...
    struct HashCode<decaf::lang::Pointer<T>>
        : public HashCodeUnaryBase<decaf::lang::Pointer<T>>
    {
