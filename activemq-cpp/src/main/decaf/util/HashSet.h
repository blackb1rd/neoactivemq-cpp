...
namespace util
{
     ...
     * the elements properly among the buckets. Iterating over this set requires
     ...
     * access a hash set concurrently, and at least one of the threads modifies
    ...
    public:
        ...
        HashSet()
            : AbstractSet<E>(),
              backingMap(new HashMap<E, Set<E>*, HASHCODE>())
        {
        }
        ...
        HashSet(int capacity)
            : AbstractSet<E>(),
              backingMap(new HashMap<E, Set<E>*, HASHCODE>(capacity))
        {
        }
        ...
        HashSet(int capacity, float loadFactor)
            : AbstractSet<E>(),
              backingMap(
                  new HashMap<E, Set<E>*, HASHCODE>(capacity, loadFactor))
        {
        }
    ...
    protected:
        /**
         * Protected constructor for use by subclasses that wish to use an
         * alternate type of backing Map.
         *
         * @param backingMap
    ...
    public:
         ...
         * contains no element e2 such that (e == e2). If this set already
         ...
         * formally, removes an element e such that (e == value), if this set
         * contains such an element. Returns true if this set contained the
