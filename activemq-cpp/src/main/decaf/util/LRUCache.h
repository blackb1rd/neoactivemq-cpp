...
namespace util
{
    ...
    public:
         ...
         */
        LRUCache()
            : LinkedHashMap<K, V, HASHCODE>(0, 0.75f, true),
              maxCacheSize(10000)
        {
        }
        ...
        /**
         * Constructs an empty LRUCache instance with the specified initial
         * capacity, maximumCacheSize, load factor and ordering mode.
         *
        ...
        LRUCache(int   initialCapacity,
                 ...
                 float loadFactor,
                 bool  accessOrder)
            : LinkedHashMap<K, V, HASHCODE>(initialCapacity,
                                            loadFactor,
                                            accessOrder),
              maxCacheSize(maximumCacheSize)
        {
