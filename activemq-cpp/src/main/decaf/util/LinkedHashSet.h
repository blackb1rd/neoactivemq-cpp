...
namespace util
{
     ...
     * cost associated with TreeSet. It can be used to produce a copy of a set
     * that has the same order as the original, regardless of the original set's
     * implementation:
     *
     ...
     * elements. Like HashSet, it provides constant-time performance for the
     * basic operations (add, contains and remove), assuming the hash function
     * disperses elements properly among the buckets. Performance is likely to
     * be just slightly below that of HashSet, due to the added expense of
     * maintaining the linked list, with one exception: Iteration over a
     * LinkedHashSet requires time proportional to the size of the set,
     * regardless of its capacity. Iteration over a HashSet is likely to be more
     ...
     * capacity and load factor. They are defined precisely as for HashSet.
     * Note, however, that the penalty for choosing an excessively high value
     * for initial capacity is less severe for this class than for HashSet, as
     * iteration times for this class are unaffected by capacity.
     *
     * Note that this implementation is not synchronized. If multiple threads
     * access a linked hash set concurrently, and at least one of the threads
     ...
     * except through the iterator's own remove method, the iterator will throw
     * a std::runtime_error. Thus, in the face of concurrent
    ...
    public:
        ...
        LinkedHashSet(int capacity)
            : HashSet<E, HASHCODE>(
                  new LinkedHashMap<E, Set<E>*, HASHCODE>(capacity))
        {
        }
        ...
        LinkedHashSet(int capacity, float loadFactor)
            : HashSet<E, HASHCODE>(
                  new LinkedHashMap<E, Set<E>*, HASHCODE>(capacity, loadFactor))
        {
        }
