...
namespace util
{
     ...
     * allow null elements at all. It is not inconceivable that someone might
     * wish to implement a list that prohibits duplicates, by throwing runtime
     * exceptions when the user attempts to insert them, but we expect this
     * usage to be rare.
     */
    template <typename E>
    ...
    {
    public:
        // Un-hide any methods from Collection that the declarations in this
        // interface hid.
