...
Properties::Properties()
    : internal(new PropertiesInternal()),
      defaults()
{
}
...
////////////////////////////////////////////////////////////////////////////////
std::string Properties::setProperty(const std::string& name,
...
////////////////////////////////////////////////////////////////////////////////
void Properties::selectProperties(
    StlMap<std::string, std::string>& selectProperties) const
{
                    ...
                    case '\r':
                        ...
                        if (offset > 0 || (offset == 0 && keyLength == 0))
                        {
                            ...
                            this->internal->properties.put(
                                temp.substr(0, (std::size_t)keyLength),
                                temp.substr((std::size_t)keyLength));
                        }
...
////////////////////////////////////////////////////////////////////////////////
void Properties::store(decaf::io::OutputStream*    out,
                       const std::string& comments DECAF_UNUSED)
{
    try
    {
        if (out == NULL)
        ...
        out->write((const unsigned char*)writer.str().c_str(),
                   length,
                   0,
                   length);
        out->flush();
...
////////////////////////////////////////////////////////////////////////////////
void Properties::store(decaf::io::Writer*          writer,
                       const std::string& comments DECAF_UNUSED)
{
    try
    {
