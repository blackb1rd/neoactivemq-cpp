...
namespace util
{
     ...
     * While priority queue orders its elements according to a comparator
     ...
     * methods.
     *
     * Unlike the Java Queue interface the methods of this class cannot return
     * null to indicate that a Queue is empty since null has no meaning for
     * elements such as classes, structs and primitive types and cannot be used
     * in a meaningful way to check for an empty queue.  Methods that would have
     * returned null in the Java Queue interface have been altered to return a
     * boolean value indicating if the operation succeeded and take single
     * argument that is a reference to the location where the returned value is
     * to be assigned.  This implies that elements in the Queue must be
     * <em>assignable</em> in order to utilize these methods.
     *
     * @since 1.0
     */
    template <typename E>
    ...
    public:
        ...
        /**
         * Inserts the specified element into the queue provided that the
         * condition allows such an operation. The method is generally
         * preferable to the collection.add(E), since the latter might throw an
        ...
        /**
         * Gets and removes the element in the head of the queue.  If the
         * operation succeeds the value of the element at the head of the Queue
         * is assigned to the result parameter and the method returns true.  If
         * the operation fails the method returns false and the value of the
        ...
        /**
         * Gets but not removes the element in the head of the queue.  The
         * result if successful is assigned to the result parameter.
         *
         * @param result
         *        Reference to an instance of the contained type to assigned the
         * removed value to.
