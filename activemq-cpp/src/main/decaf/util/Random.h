...
namespace util
{
    ...
    /**
     * Random Value Generator which is used to generate a stream of pseudorandom
     * numbers. <p> The algorithms implemented by class Random use a protected
     * utility method that on each invocation can supply up to 32 pseudorandomly
     * generated bits.
     *
     * @since 1.0
     */
