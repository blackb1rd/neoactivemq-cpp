...
namespace util
{
    ...
    /**
     * List class that wraps the STL list object to provide a simpler interface
     * and additional methods not provided by the STL type.
     */
    template <typename E>
    ...
    public:
        ...
        {
            const StlList<E>* listptr =
                dynamic_cast<const StlList<E>*>(&collection);
            if (listptr == NULL)
            {
        ...
        virtual bool addAll(const Collection<E>& collection)
        {
            ...
            std::unique_ptr<ListIterator<E>> iter(
                this->listIterator((int)this->values.size()));
        ...
        virtual int lastIndexOf(const E& value) const
        {
            ...
            return (int)(this->size() - std::distance(values.rbegin(), iter) -
                         1);
        }
