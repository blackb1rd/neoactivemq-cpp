...
namespace util
{
    ...
    private:
        ...
        public:
            ConstEntryIterator(const StlMap* parent)
        ...
        public:
            ConstKeyIterator(const StlMap* parent)
                : ConstAbstractMapIterator(parent)
            {
            }
        ...
        public:
            ConstValueIterator(const StlMap* parent)
                : ConstAbstractMapIterator(parent)
            {
            }
    ...
    private:
        ...
        public:
            ConstStlMapEntrySet(const StlMap* parent)
                : AbstractSet<MapEntry<K, V>>(),
                  associatedMap(parent)
            {
            }
    ...
    private:
        ...
        public:
            ConstStlMapKeySet(const StlMap* parent)
                : AbstractSet<K>(),
                  associatedMap(parent)
            {
            }
    ...
    private:
        ...
        public:
            StlMapValueCollection(StlMap* parent)
        ...
        public:
            ConstStlMapValueCollection(const StlMap* parent)
                : AbstractCollection<V>(),
                  associatedMap(parent)
            {
            }
