...
namespace util
{
    ...
    public:
         ...
         * Returns false if the task was scheduled for one-time execution and
         * has already run, or if the task was never scheduled, or if the task
         * was already canceled. (Loosely speaking, this method returns true if
         ...
         * execution of this task. (If this method is invoked while task
         * execution is in progress, the return value is the scheduled execution
         * time of the ongoing task execution.)
         *
