...
namespace util
{
    namespace concurrent
    {
        ...
        /**
         * A decaf::util::Queue that additionally supports operations that wait
         * for the queue to become non-empty when retrieving an element, and
         * wait for space to become available in the queue when storing an
         * element.
         *
         * <tt>BlockingQueue</tt> methods come in four forms, with different
         * ways of handling operations that cannot be satisfied immediately, but
         * may be satisfied at some point in the future: one throws an
         * exception, the second returns a special value (either <tt>true</tt>
         * or <tt>false</tt>, depending on the operation), the third blocks the
         * current thread indefinitely until the operation can succeed, and the
         ...
         *    <td>{@link #offer(Object, long, TimeUnit) offer(e, time,
         * unit)}</td>
         *  </tr>
         *  <tr>
         *    <td><b>Remove</b></td>
         ...
         * </table>
         *
         * A <tt>BlockingQueue</tt> may be capacity bounded. At any given time
         * it may have a <tt>remainingCapacity</tt> beyond which no additional
         * elements can be <tt>put</tt> without blocking.  A
         * <tt>BlockingQueue</tt> without any intrinsic capacity constraints
         * always reports a remaining capacity of <tt>Integer::MAX_VALUE</tt>.
         *
         * <tt>BlockingQueue</tt> implementations are designed to be used
         * primarily for producer-consumer queues, but additionally support
         * {@link decaf::util::Collection} interface.  So, for example, it is
         * possible to remove an arbitrary element from a queue using
         * <tt>remove(x)</tt>. However, such operations are in general
         * <em>not</em> performed very efficiently, and are intended for only
         * occasional use, such as when a queued message is cancelled.
         *
         * <tt>BlockingQueue</tt> implementations are thread-safe.  All queuing
         ...
         *
         * <p>
         * Usage example, based on a typical producer-consumer scenario.  Note
         * that a <tt>BlockingQueue</tt> can safely be used with multiple
         * producers and multiple consumers. <pre> class Producer : public
         * Runnable { private:
         *
         *     BlockingQueue* queue;
         *
         ...
         * <em>happen-before</em> actions subsequent to the access or removal of
         * that element from the BlockingQueue in another thread.
         *
         * @since 1.0
         */
        template <typename E>
        ...
        public:
             ...
             * available.
             *
             * @param result the referenced value that will be assigned the
             * value retrieved from the Queue.  Undefined if this methods
             * returned false.
             * @param timeout how long to wait before giving up, in units of
             * <tt>unit</tt>
             * @param unit a <tt>TimeUnit</tt> determining how to interpret the
             ...
             * without blocking, or <tt>Integer::MAX_VALUE</tt> if there is no
             * intrinsic limit.
             *
             * <p>Note that you <em>cannot</em> always tell if an attempt to
             * insert an element will succeed by inspecting
             * <tt>remainingCapacity</tt> because it may be the case that
             * another thread is about to insert or remove an element.
             *
            ...
            /**
             * Removes all available elements from this queue and adds them to
