...
namespace util
{
    namespace concurrent
    {
        ...
        /*
         * Exception indicating that the result of a value-producing task, such
         * as a FutureTask, cannot be retrieved because the task was canceled.
         */
        ...
        public:
             ...
             * message
             */
            CancellationException(const char* file,
