...
namespace util
{
    namespace concurrent
    {
        ...
        /**
         * Interface for a Map type that provides additional atomic putIfAbsent,
         * remove, and replace methods alongside the already available Map
         * interface.
         *
         * @since 1.0
         */
        ...
        public:
             ...
             * { map.put( key, newValue ); return true; } else { return false;
             * }
             * </pre>
             * except that the action is performed atomically.
             *
             ...
             */
            virtual bool replace(const K& key,
                                 const V& oldValue,
                                 const V& newValue) = 0;
