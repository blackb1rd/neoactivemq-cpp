    ...
    namespace concurrent
    {
        ...
        private:
            struct Array
            {
                ...
                Array(const Array& src, int capacity)
                    : size(0),
                      capacity(0),
                      elements(NULL)
                {
                    ...
                    if (src.size > 0)
                    {
                        decaf::lang::System::arraycopy<E>(src.elements,
                                                          0,
                                                          this->elements,
                                                          0,
                                                          src.size);
                ...
                void reserve(int requested)
                {
                    if (capacity < requested)
                    {
                        ...
                        int newlen =
                            decaf::lang::Math::max((int)(capacity * 1.5),
                                                   requested);
                        E* newbuf = newlen ? new E[newlen] : NULL;

                        if (this->elements != NULL)
                        {
                            decaf::lang::System::arraycopy<E>(this->elements,
                                                              0,
                                                              newbuf,
                                                              0,
                                                              size);
        ...
        private:
            mutable decaf::util::concurrent::locks::ReentrantReadWriteLock
                arrayLock;
            decaf::lang::Pointer<decaf::util::concurrent::locks::Condition>
                                        condition;
        ...
        public:
            CopyOnWriteArrayList<E>& operator=(
                const CopyOnWriteArrayList<E>& list)
            {
        ...
        public:  // Collections API
            ...
            virtual bool add(const E& value)
            {
                ...
                try
                {
                    ...
                    decaf::lang::Pointer<Array> newArray(
                        new Array(*oldArray, size + 1));
            ...
            virtual bool addAll(const Collection<E>& collection)
            {
                ...
                try
                {
                    ...
                    int                         size     = oldArray->size;
                    decaf::lang::Pointer<Array> newArray(
                        new Array(*oldArray, size + collection.size()));
            ...
            virtual bool equals(const Collection<E>& collection) const
            {
                ...
                const List<E>* asList =
                    dynamic_cast<const List<E>*>(&collection);
                if (asList == NULL)
                {
                    return false;
                }
        ...
        public:  // List API
            ...
            virtual void add(int index, const E& element)
            {
                ...
                try
                {
                    ...
                    if (size > 0)
                    {
                        decaf::lang::System::arraycopy<E>(oldArray->elements,
                                                          0,
                                                          newArray->elements,
                                                          0,
                                                          index);
            ...
            virtual bool addAll(int index, const Collection<E>& collection)
            {
                ...
                try
                {
                    ...
                    decaf::lang::Pointer<Array> newArray(
                        new Array(size + csize));
                    if (size > 0)
                    {
                        decaf::lang::System::arraycopy(oldArray->elements,
                                                       0,
                                                       newArray->elements,
                                                       0,
                                                       index);
        ...
        public:
            /**
             * Adds the given value to the end of this List if it is not already
             * contained in this List.
             *
             * @param value
             *      The element to be added if not already contained in this
             * List.
             *
            ...
            /**
             * Every element in the given collection that is not already
             * contained in this Collection is added to the end of this
             * collection.  The order that the elements are added is ditacted by
             * the order that the collection's iterator returns them.
             *
             * @param collection
             *      The collection whose elements are to be added if not already
             * in this List.
             *
            ...
            int addAllAbsent(const Collection<E>& collection)
            {
                ...
                try
                {
                    decaf::lang::Pointer<Array> oldArray = this->array;
                    int                         size     = oldArray->size;
                    decaf::lang::Pointer<Array> buffer(
                        new Array(collection.size()));
                    int count = 0;
                    ...
                    decaf::lang::Pointer<Array> newArray(
                        new Array(*oldArray, size + count));
                    decaf::lang::System::arraycopy(buffer->elements,
                                                   0,
                                                   newArray->elements,
                                                   size,
                                                   count);
            ...
            /**
             * Searches backwards through the List for the given element
            ...
            /**
             * Searches the List starting from the specified index and returns
             * the index of the first item in the list that is equal to the
             * given value.
             *
             * @param value
             *      The value to search for in the List.
        ...
        public:  // Synchronizable
            ...
            virtual void wait(long long millisecs)
            {
                this->condition->await(
                    millisecs,
                    decaf::util::concurrent::TimeUnit::MILLISECONDS);
            }

            virtual void wait(long long millisecs, int nanos)
            {
                long long timeout =
                    decaf::util::concurrent::TimeUnit::MILLISECONDS.toNanos(
                        millisecs) +
                    nanos;
