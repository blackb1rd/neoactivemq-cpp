...
namespace util
{
    namespace concurrent
    {
        ...
        /**
         * Since the CopyOnWriteArraySet and the CopyOnWriteArrayList share much
         * of the same operational semantics this class uses the
         * CopyOnWriteArrayList for all its underlying operations.
         *
         * This collection is best used in applications where the Set size is
         * usually small and write operations are minimal as they result in a
         * copy of the underlying array being created.  Reads are generally fast
         * and the iterators provided by this collection do not block as they
         * operate on a snapshot of the data taken at the time of their
         * creation.
         *
         * @since 1.0
         */
