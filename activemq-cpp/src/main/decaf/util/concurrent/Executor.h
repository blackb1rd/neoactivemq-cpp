...
namespace util
{
    namespace concurrent
    {
        ...
        /**
         * An object that executes submitted {@link decaf.lang.Runnable} tasks.
         ...
         * implement {@link decaf.util.concurrent.ExecutorService}, which is a
         * more extensive interface.  The {@link
         * decaf.util.concurrent.ThreadPoolExecutor} class provides an
         * extensible thread pool implementation. The
         * {@link decaf.util.concurrent.Executor} class provides convenient
        ...
        public:
            ...
            /**
             * This method is the same as calling the two param execute method
             * and passing true as the second argument.
             *
             * @param command
             ...
             * the calling thread, at the discretion of the <tt>Executor</tt>
             * implementation.
             *
             * @param command
             *      The runnable task to be executed.
             * @param takeOwnership
             *      Indicates if the Executor should assume ownership of the
             * task and delete the pointer once the task has completed.
             *
             * @throws RejectedExecutionException if this task cannot be
             *         accepted for execution.
             *
