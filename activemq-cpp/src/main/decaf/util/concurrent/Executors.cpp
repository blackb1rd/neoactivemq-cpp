...
public:
    ...
    Thread* newThread(Runnable* task)
    {
        Thread* thread = new Thread(
            task,
            namePrefix + Integer::toString(threadNumber.getAndIncrement()));
...
private:
    ...
    NonConfigurableExecutorService& operator=(
        const NonConfigurableExecutorService&);

public:
    NonConfigurableExecutorService(ExecutorService* service)
...
ExecutorService* Executors::newSingleThreadExecutor()
{
    ...
    try
    {
        ...
        NonConfigurableExecutorService* result =
            new NonConfigurableExecutorService(service);
...
////////////////////////////////////////////////////////////////////////////////
ExecutorService* Executors::unconfigurableExecutorService(
    ExecutorService* executor)
{
    try
    {
        ...
        NonConfigurableExecutorService* result =
            new NonConfigurableExecutorService(executor);
