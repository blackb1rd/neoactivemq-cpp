...
namespace util
{
    namespace concurrent
    {
         ...
         * timing and delay operations in these units. A TimeUnit does not
         * maintain time information, but only helps organize and use time
         * representations that may be maintained separately across various
         * contexts. A nanosecond is defined as one thousandth of a microsecond,
         * a microsecond as one thousandth of a millisecond, a millisecond as
         * one thousandth of a second, a minute as sixty seconds, an hour as
        ...
        public:
             ...
             * Long.MIN_VALUE if negative or Long.MAX_VALUE if positive. <p> For
             * example, to convert 10 minutes to milliseconds, use:
             ...
             */
            long long convert(long long       sourceDuration,
             ...
             * This is a convenience method that converts time arguments into
             * the form required by the <tt>Thread.join</tt> method.
             *
             ...
             * This is a convenience method that converts time arguments into
             * the form required by the <tt>Thread.sleep</tt> method.
        ...
        public:  // Static Methods
            /**
             * Returns the TimeUnit constant of this type with the specified
             * name. The string must match exactly an identifier used to declare
             * an TimeUnit constant in this type. (Extraneous whitespace
        ...
        private:
            ...
            long long doConvert(int       srcIndex,
                                int       destIndex,
             ...
             * @param overflow - The value at which d * m would cause an
             * overflow.
             */
            static long long scale(long long duration,
