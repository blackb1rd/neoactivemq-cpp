...
namespace util
{
    namespace concurrent
    {
        namespace locks
        {
            ...
            /**
             * Fairness Policy base class that uses the
             * AbstraactQueuedSynchronizer to do most of the heavy lifting for
             * the ReentrantLock object.
             */
            ...
            public:
                ...
                /**
                 * Performs non-fair tryLock.  tryAcquire is implemented by each
                 * of the policy subclasses but both can make use of a non-fair
                 * try.
                 */
            ...
            /**
             * The fair policy only lets a Thread acquire if the lock is not
             * held, the call amounts to a recursive lock, or the Thread is the
             * first one in line.
             */
...
////////////////////////////////////////////////////////////////////////////////
Collection<decaf::lang::Thread*>* ReentrantLock::getWaitingThreads(
