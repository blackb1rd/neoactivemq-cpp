...
public:
    ...
    bool tryReleaseShared(int unused DECAF_UNUSED)
    {
        ...
        for (;;)
        {
            ...
            {
                // Releasing the read lock has no effect on readers, but it may
                // allow waiting writers to proceed if both read and write locks
                // are now free.
                return nextc == 0;
            }
        }
...
protected:
     ...
     * lock, and otherwise eligible to do so, should block because of policy for
    ...
    namespace concurrent
    {
        namespace locks
        {
            ...
            private:
                ...
                ReentrantReadWriteLockImpl& operator=(
            ...
            public:
                ...
                ReentrantReadWriteLockImpl(bool fair)
                    : readLock(NULL),
                      writeLock(NULL),
                      sync(NULL)
                {
...
ReentrantReadWriteLock::ReentrantReadWriteLock()
    : ReadWriteLock(),
      impl(new ReentrantReadWriteLockImpl(false))
{
}
...
ReentrantReadWriteLock::ReentrantReadWriteLock(bool fair)
    : ReadWriteLock(),
      impl(new ReentrantReadWriteLockImpl(fair))
{
}
...
bool ReentrantReadWriteLock::hasWaiters(Condition* condition) const
{
    ...
    const AbstractQueuedSynchronizer::ConditionObject* cond =
        dynamic_cast<const AbstractQueuedSynchronizer::ConditionObject*>(
            condition);
...
////////////////////////////////////////////////////////////////////////////////
Collection<decaf::lang::Thread*>* ReentrantReadWriteLock::getWaitingThreads(
