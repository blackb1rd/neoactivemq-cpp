...
namespace util
{
    namespace logging
    {
        ...
        /**
         * ErrorManager objects can be attached to Handlers to process any error
         * that occur on a Handler during Logging.
         *
         * When processing logging output, if a Handler encounters problems then
         * rather than throwing an Exception back to the issuer of the logging
         * call (who is unlikely to be interested) the Handler should call its
         * associated ErrorManager.
         *
         * @since 1.0
         */
        ...
        public:
            /**
             * GENERIC_FAILURE is used for failure that don't fit into one of
        ...
        public:
             ...
             * in this base class is that the first call is reported to
