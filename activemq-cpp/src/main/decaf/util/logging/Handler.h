...
namespace util
{
    namespace logging
    {
         ...
         * It might for example, write them to a console or write them to a
         * file, or send them to a network logging service, or forward them to
         * an OS log, or whatever.
         *
        ...
        public:
             ...
             * Sets the <code>Formatter</code> used by this Handler
             * <p>
             * The ErrorManager's "error" method will be invoked if any errors
             * occur while using this Handler.
             *
