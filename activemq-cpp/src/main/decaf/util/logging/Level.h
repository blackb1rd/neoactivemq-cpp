...
namespace util
{
    namespace logging
    {
         ...
         * messages.
         *
         * It is possible for third parties to define additional logging levels
         * by subclassing Level. In such cases subclasses should take care to
         * chose unique integer level values.
         *
         * @since 1.0
         */
        ...
        public:
             ...
             * its Level from its parent Logger, the value is initialized as
             * zero.
             */
             ...
             * level is initialized to Integer::MAX_VALUE
             */
             ...
             * and to system administrators. This level is initialized to 1000.
             */
             ...
             * admins. This level is initialized to 800.
             */
             ...
             *
             * DEBUG messages are intended to provide a more detailed message
             * intended for use by developers in tracking the behavior of a
             * client.  DEBUG messages typically contain more implementation
             * specific information that might not be significant to end users
             * or system admins.  This level is initialized to 700.
             */
             ...
             * CONFIG message might include the CPU type, the System properties,
             * etc. This level is initialized to 600.
             */
             ...
             * detailed tracing. The exact meaning of the three levels will vary
             * between subsystems, but in general, FINEST should be used for the
             * most detailed output, FINER for somewhat less detailed output,
             * and FINE for the lowest volume (and most important) messages.
             *
            ...
            /**
             * FINER indicates a fairly detailed tracing message. By default
             ...
             * initialized to Integer::MIN_VALUE.
             */
        ...
        public:
             ...
             *
             * The argument string may consist of either a level name or an
             * integer value.
             *
             * For example:
             *
             ...
             *
             * @return the parsed Level value, passing in a level name that is
             * an int value that is not one of the known Level values will
