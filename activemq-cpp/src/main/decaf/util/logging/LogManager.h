...
namespace util
{
    namespace logging
    {
         ...
         * "decaf.util.logging.config.file" system property can be used to
         * specify a properties file (in decaf.util.Properties format). The
         ...
         *      name must be for a Handler class which has a default
         * constructor. Note that these Handlers may be created lazily, when
         * they are first used.
         *    * A property "<logger>.handlers". This defines a whitespace or
         *      comma separated list of class names for handlers classes to load
         *      and register as handlers to the specified logger. Each class
         * name must be for a Handler class which has a default constructor.
         * Note that these Handlers may be created lazily, when they are first
         *      used.
         ...
         * may execute arbitrary code to update the logging configuration, such
        ...
        public:
            ...
            /**
             * Add a named logger. This does nothing and returns false if a
             * logger with the same name is already registered.
             *
            ...
            /**
             * Gets a list of known Logger Names from this Manager, new loggers
             * added while this method is in progress are not garunteed to be in
             * the list.
             *
             * @param names
             ...
             *
             * A PropertyChangeEvent will be fired after the properties are
             * read.
             *
            ...
            /**
             * Reinitialize the logging properties and reread the logging
             * configuration from the given stream, which should be in
             * decaf.util.Properties format. A PropertyChangeEvent will be fired
             ...
             *
             * For all named loggers, the reset operation removes and closes all
             * Handlers and (except for the root logger) sets the level to
             * INHERIT. The root logger's level is set to Level::INFO.
             */
            void reset();
