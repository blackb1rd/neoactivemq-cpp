...
namespace util
{
    namespace logging
    {
        ...
        public:
            ...
            /**
             * Sets the Throwable associated with this LogRecord, the pointer
             * becomes the property of this instance of the LogRecord and will
             * be deleted when the record is destroyed.
             *
             * @param thrown
             *      A pointer to a Throwable that will be associated with this
             * record.
             */
