...
namespace util
{
    namespace logging
    {
         ...
         *
         * This is primarily intended as a base class or support class to be
         * used in implementing other logging Handlers.
         *
         * LogRecords are published to a given
         * <code>decaf::io::OutputStream</code>.
         *
         * Configuration: By default each StreamHandler is initialized using the
         ...
         * are used.
         *
         *   * decaf.util.logging.StreamHandler.level specifies the default
         * level for the Handler (defaults to Level.INFO).
         *   * decaf.util.logging.StreamHandler.filter specifies the name of a
         * Filter class to use (defaults to no Filter).
         *   * decaf.util.logging.StreamHandler.formatter specifies the name of
         * a Formatter class to use (defaults to
        ...
        public:
             ...
             * Create a StreamHandler, with no current output stream.
             */
            StreamHandler(decaf::io::OutputStream* stream,
                          Formatter*               formatter);
             ...
             * After close has been called this Handler  should no longer be
             * used. Method calls may either be silently ignored or may throw
             * runtime exceptions.
             *
        ...
        protected:
             ...
             *
             * If there is a current output stream then the Formatter's tail
             * string is written and the stream is flushed and closed. Then the
             * output stream is replaced with the new output stream.
             *
             * @param stream
            ...
            /**
             * Closes this handler, but the underlying output stream is only
             * closed if closeStream is true.
             *
             * @param closeStream
        ...
        private:
            // Safely writes the string to the output stream, calling the
            // ErrorManager if any exceptions are thrown while writing.
