...
namespace util
{
    namespace zip
    {
         ...
         *
         * Basically this class is part of the API to the stream based ZLIB
         * compression library and is used as such by DeflaterOutputStream and
         * its descendants.
         *
         * The typical usage of a Deflater instance outside this package
         * consists of a specific call to one of its constructors before being
         * passed to an instance of DeflaterOutputStream.
         *
        ...
        public:
            ...
            /**
             * Compression method for the deflate algorithm (the only one
             * currently supported).
             */
             ...
             * small values with a somewhat random distribution. Forces more
        ...
        public:
             ...
             * @param nowrap
             *      If true uses GZip compatible compression (defaults to
             * false).
             */
            ...
            /**
             * Sets preset dictionary for compression. A preset dictionary is
             * used when the history buffer can be predetermined. When the data
             * is later uncompressed with Inflater.inflate(),
             * Inflater.getAdler() can be called in order to get the Adler-32
             * value of the dictionary required for decompression.
             *
             * @param buffer
            ...
            /**
             * Fills specified buffer with compressed data. Returns actual
             * number of bytes of compressed data. A return value of 0 indicates
             * that needsInput() should be called in order to determine if more
            ...
            /**
             * Closes the compressor and discards any unprocessed input. This
             * method should be called when the compressor is no longer being
             * used, but will also be called automatically by the destructor.
             * Once this method is called, the behavior of the Deflater object
             * is undefined.
             */
            void end();
        };
