...
namespace util
{
    namespace zip
    {
        ...
        public:
            static void initZlibInflate(InflaterData* handle,
                                        bool          nowrap = false)
            {
                if (handle == NULL)
                {
...
////////////////////////////////////////////////////////////////////////////////
void Inflater::setInput(const unsigned char* buffer,
                        int                  size,
                        int                  offset,
                        int                  length)
{
...
////////////////////////////////////////////////////////////////////////////////
void Inflater::setDictionary(const unsigned char* buffer,
                             int                  size,
                             int                  offset,
                             int                  length)
{
    try
    {
        ...
        // inflate().
        int result = inflateSetDictionary(this->data->stream,
                                          buffer + offset,
                                          (uInt)length);
        if (result != Z_OK)
        {
    ...
    try
    {
        ...
        else if (result == Z_NEED_DICT)
        {
            if (this->needsDictionary())
            {
                throw DataFormatException(
                    __FILE__,
                    __LINE__,
                    "Inflate cannot proceed until a Dictionary is set.");
            }
        ...
        else if (result == Z_DATA_ERROR)
        {
            throw DataFormatException(
                __FILE__,
                __LINE__,
                "Inflate failed because a block of invalid data was found.");
        }
