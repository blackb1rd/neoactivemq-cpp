...
namespace util
{
    namespace zip
    {
        ...
        /**
         * This class uncompresses data that was compressed using the
         * <i>DEFLATE</i> algorithm (see <a
         * href="http://www.gzip.org/algorithm.txt">specification</a>). <p>
         * Basically this class is part of the API to the stream based ZLIB
         * compression library and is used as such by InflaterInputStream and
         * its descendants. <p> The typical usage of a Inflater outside this
         * package consists of a specific call to one of its constructors before
         * being passed to an instance of InflaterInputStream.
         *
        ...
        public:
            /**
             * Creates a new decompressor.  This constructor defaults the
             * inflater to use the ZLIB header and checksum fields.
             */
            Inflater();
            ...
            /**
             * Sets input data for decompression. This should be called whenever
             ...
             * called when inflate() returns 0 and needsDictionary() returns
             * true indicating that a preset dictionary is required. The method
             * getAdler() can be used to get the Adler-32 value of the
             * dictionary needed.
             *
             * @param buffer
             *      The Buffer to read in for decompression.
            ...
            /**
             * When called, indicates that decompression should end with the
             ...
             * method should be called when the decompressor is no longer being
             * used, but will also be called automatically by the destructor.
             * Once this method is called, the behavior of the Inflater object
             * is undefined.
             */
            void end();
        };
