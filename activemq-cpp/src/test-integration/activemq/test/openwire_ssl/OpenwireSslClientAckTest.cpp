...
#include <activemq/test/openwire/ClientAckTest.h>

namespace activemq{
namespace test{
namespace openwire_ssl{
    class OpenwireSslClientAckTest : public openwire::ClientAckTest {
    public:
