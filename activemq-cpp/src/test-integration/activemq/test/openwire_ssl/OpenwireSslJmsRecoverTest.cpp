...
#include <activemq/test/openwire/JmsRecoverTest.h>

namespace activemq{
namespace test{
namespace openwire_ssl{
    class OpenwireSslJmsRecoverTest : public openwire::JmsRecoverTest {
    public:
