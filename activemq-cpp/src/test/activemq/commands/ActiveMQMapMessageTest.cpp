...
TEST_F(ActiveMQMapMessageTest, test)
{
    ...
    ASSERT_TRUE(myMessage.getDataStructureType() ==
                ActiveMQMapMessage::ID_ACTIVEMQMAPMESSAGE);
...
TEST_F(ActiveMQMapMessageTest, testGetMapNames)
{
    ...
    ASSERT_TRUE(std::find(mapNamesList.begin(),
                          mapNamesList.end(),
                          "boolean") != mapNamesList.end());
    ASSERT_TRUE(std::find(mapNamesList.begin(), mapNamesList.end(), "byte") !=
                mapNamesList.end());
    ASSERT_TRUE(std::find(mapNamesList.begin(), mapNamesList.end(), "bytes1") !=
                mapNamesList.end());
    ASSERT_TRUE(std::find(mapNamesList.begin(), mapNamesList.end(), "bytes2") !=
                mapNamesList.end());
    ASSERT_TRUE(std::find(mapNamesList.begin(), mapNamesList.end(), "char") !=
                mapNamesList.end());
    ASSERT_TRUE(std::find(mapNamesList.begin(), mapNamesList.end(), "double") !=
                mapNamesList.end());
    ASSERT_TRUE(std::find(mapNamesList.begin(), mapNamesList.end(), "float") !=
                mapNamesList.end());
    ASSERT_TRUE(std::find(mapNamesList.begin(), mapNamesList.end(), "int") !=
                mapNamesList.end());
    ASSERT_TRUE(std::find(mapNamesList.begin(), mapNamesList.end(), "long") !=
                mapNamesList.end());
    ASSERT_TRUE(std::find(mapNamesList.begin(), mapNamesList.end(), "short") !=
                mapNamesList.end());
    ASSERT_TRUE(std::find(mapNamesList.begin(), mapNamesList.end(), "string") !=
                mapNamesList.end());
}
