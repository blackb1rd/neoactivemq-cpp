...
///////////////////////////////////////////////////////////////////////////////
TEST_F(ActiveMQBlobMessageMarshallerTest, test)
{
    ...
    myCommand2 =
        dynamic_cast<ActiveMQBlobMessage*>(myMarshaller.createObject());
    ASSERT_TRUE(myCommand2 != NULL);
    delete myCommand2;
}

///////////////////////////////////////////////////////////////////////////////
TEST_F(ActiveMQBlobMessageMarshallerTest, testLooseMarshal)
{
...
///////////////////////////////////////////////////////////////////////////////
TEST_F(ActiveMQBlobMessageMarshallerTest, testTightMarshal)
{
    ActiveMQBlobMessageMarshaller marshaller;
    Properties                    props;
    OpenWireFormat                openWireFormat(props);
