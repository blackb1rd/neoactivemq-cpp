...
///////////////////////////////////////////////////////////////////////////////
TEST_F(ActiveMQObjectMessageMarshallerTest, test)
{
    ...
    myCommand2 =
        dynamic_cast<ActiveMQObjectMessage*>(myMarshaller.createObject());
    ASSERT_TRUE(myCommand2 != NULL);
    delete myCommand2;
}

///////////////////////////////////////////////////////////////////////////////
TEST_F(ActiveMQObjectMessageMarshallerTest, testLooseMarshal)
{
...
///////////////////////////////////////////////////////////////////////////////
TEST_F(ActiveMQObjectMessageMarshallerTest, testTightMarshal)
{
    ActiveMQObjectMessageMarshaller marshaller;
    Properties                      props;
    OpenWireFormat                  openWireFormat(props);
