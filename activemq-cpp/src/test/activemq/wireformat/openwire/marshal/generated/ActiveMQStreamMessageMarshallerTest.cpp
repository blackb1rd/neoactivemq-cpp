...
///////////////////////////////////////////////////////////////////////////////
TEST_F(ActiveMQStreamMessageMarshallerTest, test)
{
    ...
    myCommand2 =
        dynamic_cast<ActiveMQStreamMessage*>(myMarshaller.createObject());
    ASSERT_TRUE(myCommand2 != NULL);
    delete myCommand2;
}

///////////////////////////////////////////////////////////////////////////////
TEST_F(ActiveMQStreamMessageMarshallerTest, testLooseMarshal)
{
...
///////////////////////////////////////////////////////////////////////////////
TEST_F(ActiveMQStreamMessageMarshallerTest, testTightMarshal)
{
    ActiveMQStreamMessageMarshaller marshaller;
    Properties                      props;
    OpenWireFormat                  openWireFormat(props);
