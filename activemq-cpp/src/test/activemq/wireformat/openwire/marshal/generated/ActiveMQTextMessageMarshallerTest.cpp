...
///////////////////////////////////////////////////////////////////////////////
TEST_F(ActiveMQTextMessageMarshallerTest, test)
{
    ...
    myCommand2 =
        dynamic_cast<ActiveMQTextMessage*>(myMarshaller.createObject());
    ASSERT_TRUE(myCommand2 != NULL);
    delete myCommand2;
}

///////////////////////////////////////////////////////////////////////////////
TEST_F(ActiveMQTextMessageMarshallerTest, testLooseMarshal)
{
...
///////////////////////////////////////////////////////////////////////////////
TEST_F(ActiveMQTextMessageMarshallerTest, testTightMarshal)
{
    ActiveMQTextMessageMarshaller marshaller;
    Properties                    props;
    OpenWireFormat                openWireFormat(props);
