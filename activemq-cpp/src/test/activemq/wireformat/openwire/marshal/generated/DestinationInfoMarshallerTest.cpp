...
class DestinationInfoMarshallerTest : public ::testing::Test
{
};

///////////////////////////////////////////////////////////////////////////////
TEST_F(DestinationInfoMarshallerTest, test)
{
    DestinationInfoMarshaller myMarshaller;
    DestinationInfo           myCommand;
    DestinationInfo*          myCommand2;

    ASSERT_TRUE(myMarshaller.getDataStructureType() ==
                myCommand.getDataStructureType());
    myCommand2 = dynamic_cast<DestinationInfo*>(myMarshaller.createObject());
    ASSERT_TRUE(myCommand2 != NULL);
    delete myCommand2;
}

///////////////////////////////////////////////////////////////////////////////
TEST_F(DestinationInfoMarshallerTest, testLooseMarshal)
{
    DestinationInfoMarshaller marshaller;
    Properties                props;
...
///////////////////////////////////////////////////////////////////////////////
TEST_F(DestinationInfoMarshallerTest, testTightMarshal)
{
    DestinationInfoMarshaller marshaller;
    Properties                props;
    OpenWireFormat            openWireFormat(props);
