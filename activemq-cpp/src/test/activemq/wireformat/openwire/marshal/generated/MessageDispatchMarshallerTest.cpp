...
class MessageDispatchMarshallerTest : public ::testing::Test
{
};

///////////////////////////////////////////////////////////////////////////////
TEST_F(MessageDispatchMarshallerTest, test)
{
    MessageDispatchMarshaller myMarshaller;
    MessageDispatch           myCommand;
    MessageDispatch*          myCommand2;

    ASSERT_TRUE(myMarshaller.getDataStructureType() ==
                myCommand.getDataStructureType());
    myCommand2 = dynamic_cast<MessageDispatch*>(myMarshaller.createObject());
    ASSERT_TRUE(myCommand2 != NULL);
    delete myCommand2;
}

///////////////////////////////////////////////////////////////////////////////
TEST_F(MessageDispatchMarshallerTest, testLooseMarshal)
{
    MessageDispatchMarshaller marshaller;
    Properties                props;
...
///////////////////////////////////////////////////////////////////////////////
TEST_F(MessageDispatchMarshallerTest, testTightMarshal)
{
    MessageDispatchMarshaller marshaller;
    Properties                props;
    OpenWireFormat            openWireFormat(props);
