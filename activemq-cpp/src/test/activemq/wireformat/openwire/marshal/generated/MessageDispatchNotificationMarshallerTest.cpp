...
class MessageDispatchNotificationMarshallerTest : public ::testing::Test
{
};

///////////////////////////////////////////////////////////////////////////////
TEST_F(MessageDispatchNotificationMarshallerTest, test)
{
    MessageDispatchNotificationMarshaller myMarshaller;
    MessageDispatchNotification           myCommand;
    MessageDispatchNotification*          myCommand2;

    ASSERT_TRUE(myMarshaller.getDataStructureType() ==
                myCommand.getDataStructureType());
    myCommand2 =
        dynamic_cast<MessageDispatchNotification*>(myMarshaller.createObject());
    ASSERT_TRUE(myCommand2 != NULL);
    delete myCommand2;
}

///////////////////////////////////////////////////////////////////////////////
TEST_F(MessageDispatchNotificationMarshallerTest, testLooseMarshal)
{
    MessageDispatchNotificationMarshaller marshaller;
    Properties                            props;
    ...
    MessageDispatchNotification inCommand;
...
///////////////////////////////////////////////////////////////////////////////
TEST_F(MessageDispatchNotificationMarshallerTest, testTightMarshal)
{
    MessageDispatchNotificationMarshaller marshaller;
    Properties                            props;
    OpenWireFormat                        openWireFormat(props);
