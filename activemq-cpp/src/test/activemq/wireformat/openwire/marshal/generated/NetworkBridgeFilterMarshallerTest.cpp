...
///////////////////////////////////////////////////////////////////////////////
TEST_F(NetworkBridgeFilterMarshallerTest, test)
{
    ...
    myCommand2 =
        dynamic_cast<NetworkBridgeFilter*>(myMarshaller.createObject());
    ASSERT_TRUE(myCommand2 != NULL);
    delete myCommand2;
}

///////////////////////////////////////////////////////////////////////////////
TEST_F(NetworkBridgeFilterMarshallerTest, testLooseMarshal)
{
...
///////////////////////////////////////////////////////////////////////////////
TEST_F(NetworkBridgeFilterMarshallerTest, testTightMarshal)
{
    NetworkBridgeFilterMarshaller marshaller;
    Properties                    props;
    OpenWireFormat                openWireFormat(props);
