...
class ProducerInfoMarshallerTest : public ::testing::Test
{
};

///////////////////////////////////////////////////////////////////////////////
TEST_F(ProducerInfoMarshallerTest, test)
{
    ProducerInfoMarshaller myMarshaller;
    ProducerInfo           myCommand;
    ProducerInfo*          myCommand2;

    ASSERT_TRUE(myMarshaller.getDataStructureType() ==
                myCommand.getDataStructureType());
    myCommand2 = dynamic_cast<ProducerInfo*>(myMarshaller.createObject());
    ASSERT_TRUE(myCommand2 != NULL);
    delete myCommand2;
}

///////////////////////////////////////////////////////////////////////////////
TEST_F(ProducerInfoMarshallerTest, testLooseMarshal)
{
    ProducerInfoMarshaller marshaller;
    Properties             props;
...
///////////////////////////////////////////////////////////////////////////////
TEST_F(ProducerInfoMarshallerTest, testTightMarshal)
{
    ProducerInfoMarshaller marshaller;
    Properties             props;
    OpenWireFormat         openWireFormat(props);
