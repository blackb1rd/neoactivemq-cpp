...
///////////////////////////////////////////////////////////////////////////////
TEST_F(RemoveSubscriptionInfoMarshallerTest, test)
{
    ...
    myCommand2 =
        dynamic_cast<RemoveSubscriptionInfo*>(myMarshaller.createObject());
    ASSERT_TRUE(myCommand2 != NULL);
    delete myCommand2;
}

///////////////////////////////////////////////////////////////////////////////
TEST_F(RemoveSubscriptionInfoMarshallerTest, testLooseMarshal)
{
...
///////////////////////////////////////////////////////////////////////////////
TEST_F(RemoveSubscriptionInfoMarshallerTest, testTightMarshal)
{
    RemoveSubscriptionInfoMarshaller marshaller;
    Properties                       props;
    OpenWireFormat                   openWireFormat(props);
