...
TEST_F(CharArrayBufferTest, testPutString)
{
    ...
    ASSERT_THROW(testBuffer1->put("ASDFGHJKJKL"), BufferOverflowException)
        << ("Should throw a BufferOverflowException");
}
...
TEST_F(CharArrayBufferTest, testPutStringWithArgs)
{
    ...
    ASSERT_THROW(testBuffer1->put(toBig, 0, testBuffer1->capacity() + 1),
                 BufferOverflowException)
        << ("Should throw a BufferOverflowException");
...
TEST_F(CharArrayBufferTest, testAppendOverFlow)
{
    ...
    ASSERT_THROW(cb->append('C'), BufferOverflowException)
        << ("Should throw a BufferOverflowException");

    ASSERT_THROW(cb->append(cs), BufferOverflowException)
        << ("Should throw a BufferOverflowException");

    ASSERT_THROW(cb->append(cs, 1, 2), BufferOverflowException)
        << ("Should throw a BufferOverflowException");
...
TEST_F(CharArrayBufferTest, testReadOnlyMap)
{
    ...
    ASSERT_THROW(cb->append('A'), ReadOnlyBufferException)
        << ("Should throw a ReadOnlyBufferException");

    ASSERT_THROW(cb->append(&cs), ReadOnlyBufferException)
        << ("Should throw a ReadOnlyBufferException");

    ASSERT_THROW(cb->append(&cs, 1, 2), ReadOnlyBufferException)
        << ("Should throw a ReadOnlyBufferException");
