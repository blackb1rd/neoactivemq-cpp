...
protected:
    ...
    void assertContentLikeTestData1(decaf::nio::DoubleBuffer* buf,
                                    int                       startIndex,
                                    double                    startValue,
                                    int                       length)
    {
...
TEST_F(DoubleArrayBufferTest, testCompareTo)
{
    ...
    ASSERT_TRUE(dbuffer1->compareTo(*dbuffer2))
...
TEST_F(DoubleArrayBufferTest, testGetDoubleArray2)
{
    ...
    testBuffer1->clear();
    DoubleBuffer& ret = testBuffer1->get(array1,
                                         testBuffer1->capacity(),
                                         0,
                                         testBuffer1->capacity());
    ASSERT_TRUE(testBuffer1->position() == testBuffer1->capacity());
...
TEST_F(DoubleArrayBufferTest, testPutDoubleArray2)
{
    ...
    DoubleBuffer& ret = testBuffer1->put(array1,
                                         testBuffer1->capacity(),
                                         0,
                                         testBuffer1->capacity());
    ASSERT_TRUE(testBuffer1->position() == testBuffer1->capacity());
