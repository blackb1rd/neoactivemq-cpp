...
TEST_F(StringTest, testDefaultConstructor)
{
    ...
    ASSERT_THROW(test.charAt(1), std::out_of_range)
...
TEST_F(StringTest, testConstructorStdString)
{
    ...
    ASSERT_THROW(test.charAt(5), std::out_of_range)
        << ("Should have thrown an std::out_of_range");
}
...
TEST_F(StringTest, testConstructorCString)
{
    ...
    ASSERT_THROW(String((const char*)NULL), std::logic_error)
...
TEST_F(StringTest, testConstructorCStringWithSize)
{
    ...
    ASSERT_THROW(String((const char*)NULL, 10), std::logic_error)
        << ("Should have thrown an std::logic_error");

    ASSERT_THROW(String(cstring, -1), std::out_of_range)
        << ("Should have thrown an std::out_of_range");
}
...
TEST_F(StringTest, testConstructorCStringOffsetAndLength)
{
    ...
    ASSERT_THROW(String((const char*)NULL, 1, 20), std::logic_error)
        << ("Should have thrown an std::logic_error");

    ASSERT_THROW(String(cstring, -1, 5), std::out_of_range)
        << ("Should have thrown an std::out_of_range");
...
TEST_F(StringTest, testConstructorCStringSizeOffsetAndLength)
{
    ...
    ASSERT_THROW(String((const char*)NULL, 7, 1, 4), std::logic_error)
        << ("Should have thrown an std::logic_error");

    ASSERT_THROW(String(cstring, -1, 0, 5), std::out_of_range)
        << ("Should have thrown an std::out_of_range");

    ASSERT_THROW(String(cstring, 7, -1, 5), std::out_of_range)
        << ("Should have thrown an std::out_of_range");
...
TEST_F(StringTest, testConstructorCharFill)
{
    ...
    ASSERT_THROW(String('A', -1), std::out_of_range)
        << ("Should have thrown an std::out_of_range");
}
...
TEST_F(StringTest, testSubstringExceptions)
{
    ...
    ASSERT_THROW(input.substring(-1, 1), std::out_of_range)
        << ("Should have thrown std::out_of_range");

    ASSERT_THROW(input.substring(4, 1), std::out_of_range)
        << ("Should have thrown std::out_of_range");

    ASSERT_THROW(input.substring(0, 100), std::out_of_range)
        << ("Should have thrown std::out_of_range");
}
...
TEST_F(StringTest, testCompareToCString)
{
    ...
    ASSERT_THROW(String("").compareTo((const char*)NULL), std::logic_error)
...
TEST_F(StringTest, testOperatorLessCString)
{
    ...
    ASSERT_THROW((void)(upper < NULL), std::logic_error)
        << ("Should have thrown a std::logic_error");
...
TEST_F(StringTest, testOperatorGreaterCString)
{
    ...
    ASSERT_THROW((void)(lower < NULL), std::logic_error)
        << ("Should have thrown a std::logic_error");
...
TEST_F(StringTest, testGetChars)
{
    ...
    ASSERT_THROW(hello.getChars(-1, 1, buffer, 10, 0), std::out_of_range)
        << ("Should have thrown a std::out_of_range");

    ASSERT_THROW(hello.getChars(1, -1, buffer, 10, 0), std::out_of_range)
        << ("Should have thrown a std::out_of_range");

    ASSERT_THROW(hello.getChars(0, 1, buffer, 10, -1), std::out_of_range)
        << ("Should have thrown a std::out_of_range");

    ASSERT_THROW(hello.getChars(1, 1, buffer, -1, 0), std::out_of_range)
        << ("Should have thrown a std::out_of_range");

    ASSERT_THROW(hello.getChars(0, 2, (char*)NULL, 10, 0), std::logic_error)
        << ("Should have thrown a std::logic_error");

    ASSERT_THROW(hello.getChars(15, 1, buffer, 10, 0), std::out_of_range)
        << ("Should have thrown a std::out_of_range");

    ASSERT_THROW(hello.getChars(0, 12, buffer, 10, 0), std::out_of_range)
        << ("Should have thrown a std::out_of_range");

    ASSERT_THROW(hello.getChars(2, 10, buffer, 10, 4), std::out_of_range)
        << ("Should have thrown a std::out_of_range");
