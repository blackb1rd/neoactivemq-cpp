...
TEST_F(ListTest, testLastIndexOf)
{
    ...
    ASSERT_TRUE(list.indexOf("bob") == 0)
        << ("indexOf 'bob' before remove failed");
    ASSERT_TRUE(list.lastIndexOf("bob") == 3)
        << ("lastIndexOf 'bob' before remove failed");

    list.remove("fred");

    ASSERT_TRUE(list.indexOf("bob") == 0)
        << ("indexOf 'bob' after remove failed");
    ASSERT_TRUE(list.lastIndexOf("bob") == 2)
        << ("lastIndexOf 'bob' after remove failed");
