...
TEST_F(UUIDTest, testConstructor1)
{
    ...
    ASSERT_EQ(0x1d07decf81d4faeLL, uuid.timestamp());
    ASSERT_EQ(130742845922168750LL, uuid.timestamp());
    ASSERT_EQ(0x2765, uuid.clockSequence());
    ASSERT_EQ(0xA0C91E6BF6LL, uuid.node());
}
...
TEST_F(UUIDTest, testGetLeastSignificantBits)
{
    ...
    ASSERT_EQ(Long::MIN_VALUE, uuid.getLeastSignificantBits());
    uuid = UUID(0, Long::MAX_VALUE);
    ASSERT_EQ(Long::MAX_VALUE, uuid.getLeastSignificantBits());
}
...
TEST_F(UUIDTest, testGetMostSignificantBits)
{
    ...
    ASSERT_EQ(Long::MIN_VALUE, uuid.getMostSignificantBits());
    uuid = UUID(Long::MAX_VALUE, 0LL);
    ASSERT_EQ(Long::MAX_VALUE, uuid.getMostSignificantBits());
}
...
TEST_F(UUIDTest, testClockSequence)
{
    ...
    ASSERT_EQ(0x0FFF, uuid.clockSequence());
...
TEST_F(UUIDTest, testCompareTo)
{
    ...
    UUID uuid2(1, 0);
    ASSERT_EQ(-1, uuid1.compareTo(uuid2));
    ASSERT_EQ(1, uuid2.compareTo(uuid1));
...
TEST_F(UUIDTest, testHashCode)
{
    ...
    ASSERT_EQ(uuid.hashCode(), uuidClone.hashCode());
}
...
TEST_F(UUIDTest, testEquals)
{
    ...
    UUID uuid2(0, 0);
    ASSERT_TRUE(uuid1.equals(uuid2));
    ASSERT_TRUE(uuid2.equals(uuid1));
...
TEST_F(UUIDTest, testFromString)
{
    ...
    ASSERT_EQ(2, actual.variant());
    ASSERT_EQ(1, actual.version());
    ASSERT_EQ(130742845922168750LL, actual.timestamp());
    ...
    ASSERT_EQ(2, actual.variant());
    ASSERT_EQ(1, actual.version());
    ASSERT_EQ(0LL, actual.timestamp());
