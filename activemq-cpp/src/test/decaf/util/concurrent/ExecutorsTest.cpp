...
TEST_F(ExecutorsTest, testDefaultThreadFactory)
{
    ...
    DefaultThreadFactoryRunnable* runner =
        new DefaultThreadFactoryRunnable(&shutdown);
...
{
    Pointer<ExecutorService> e(Executors::unconfigurableExecutorService(
