...
namespace util
{
    namespace concurrent
    {
        ...
        public:
            ...
            public:
                ShortRunnable(ExecutorsTestSupport* parent)
                    : decaf::lang::Runnable(),
                      parent(parent)
                {
                }
            ...
            public:
                SmallRunnable(ExecutorsTestSupport* parent)
                    : decaf::lang::Runnable(),
                      parent(parent)
                {
                }
            ...
            public:
                SmallCallable(ExecutorsTestSupport* parent)
                    : decaf::util::concurrent::Callable<E>(),
                      parent(parent)
                {
                }
            ...
            private:
                ...
                SmallInterruptedRunnable operator=(
                    const SmallInterruptedRunnable&);

            public:
                SmallInterruptedRunnable(ExecutorsTestSupport* parent)
                    : decaf::lang::Runnable(),
                      parent(parent)
                {
                }
            ...
            class SmallPossiblyInterruptedRunnable
            ...
            private:
                SmallPossiblyInterruptedRunnable(
                    const SmallPossiblyInterruptedRunnable&);
                SmallPossiblyInterruptedRunnable operator=(
                    const SmallPossiblyInterruptedRunnable&);

            public:
                SmallPossiblyInterruptedRunnable(ExecutorsTestSupport* parent)
                    : decaf::lang::Runnable(),
                      parent(parent)
                {
                }
            ...
            public:
                MediumRunnable(ExecutorsTestSupport* parent)
                    : decaf::lang::Runnable(),
                      parent(parent)
                {
                }
            ...
            private:
                ...
                MediumInterruptedRunnable operator=(
                    const MediumInterruptedRunnable&);

            public:
                MediumInterruptedRunnable(ExecutorsTestSupport* parent)
                    : decaf::lang::Runnable(),
                      parent(parent)
                {
                }
            ...
            class MediumPossiblyInterruptedRunnable
                : public decaf::lang::Runnable
            {
            private:
                ExecutorsTestSupport* parent;
            ...
            private:
                MediumPossiblyInterruptedRunnable(
                    const MediumPossiblyInterruptedRunnable&);
                MediumPossiblyInterruptedRunnable operator=(
                    const MediumPossiblyInterruptedRunnable&);

            public:
                MediumPossiblyInterruptedRunnable(ExecutorsTestSupport* parent)
                    : decaf::lang::Runnable(),
                      parent(parent)
                {
                }
            ...
            public:
                LongRunnable(ExecutorsTestSupport* parent)
                    : decaf::lang::Runnable(),
                      parent(parent)
                {
                }
            ...
            private:
                ...
                LongInterruptedRunnable operator=(
                    const LongInterruptedRunnable&);

            public:
                LongInterruptedRunnable(ExecutorsTestSupport* parent)
                    : decaf::lang::Runnable(),
                      parent(parent)
                {
                }
            ...
            private:
                LongPossiblyInterruptedRunnable(
                    const LongPossiblyInterruptedRunnable&);
                LongPossiblyInterruptedRunnable operator=(
                    const LongPossiblyInterruptedRunnable&);

            public:
                LongPossiblyInterruptedRunnable(ExecutorsTestSupport* parent)
                    : decaf::lang::Runnable(),
                      parent(parent)
                {
                }
            ...
            public:
                ...
                virtual void rejectedExecution(Runnable*           r,
            ...
            public:
                TrackedShortRunnable(bool* done)
                    : decaf::lang::Runnable(),
                      done(done)
                {
                }
            ...
            class StringTask
                : public decaf::util::concurrent::Callable<std::string>
            {
            public:
                StringTask()
                    : decaf::util::concurrent::Callable<std::string>()
                {
                }
