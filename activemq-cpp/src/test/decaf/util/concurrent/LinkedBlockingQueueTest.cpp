...
TEST_F(LinkedBlockingQueueTest, testRemoveElement2)
{
    ...
    q.add(SIZE + 1);
    q.remove(SIZE + 1);
    ASSERT_TRUE(!q.contains(SIZE + 1))
        << ("Should not contain null afrer removal");
}
...
public:
    PutThread(LinkedBlockingQueue<int>* q, int putValue)
        : theQ(q),
          putValue(putValue)
    {
    }
...
public:
    PuttingThread(LinkedBlockingQueue<int>* q, int count)
        : theQ(q),
          count(count)
    {
    }
...
public:
    TestBlockingPutRunnable(LinkedBlockingQueueTest* test)
        : Runnable(),
          test(test)
    {
    }
...
public:
    TestTimedOfferRunnable(LinkedBlockingQueue<int>* queue,
                           LinkedBlockingQueueTest*  test)
        : Runnable(),
          queue(queue),
          test(test)
    ...
    virtual void run()
    {
        try
        {
            ...
            test->threadAssertFalse(
                queue->offer(3,
                             LinkedBlockingQueueTest::SHORT_DELAY_MS,
                             TimeUnit::MILLISECONDS));
            queue->offer(4,
                         LinkedBlockingQueueTest::LONG_DELAY_MS,
                         TimeUnit::MILLISECONDS);
            test->threadShouldThrow();
        }
...
public:
    TestTakeFromEmptyRunnable(LinkedBlockingQueue<int>* queue,
                              LinkedBlockingQueueTest*  test)
        : Runnable(),
          queue(queue),
          test(test)
...
private:
    ...
    TestInterruptedTimedPollRunnable operator=(
        const TestInterruptedTimedPollRunnable&);
...
private:
    ...
    TestTimedPollWithOfferRunnable operator=(
        const TestTimedPollWithOfferRunnable&);

public:
    TestTimedPollWithOfferRunnable(LinkedBlockingQueue<int>* queue,
                                   LinkedBlockingQueueTest*  test)
        : Runnable(),
          queue(queue),
          test(test)
...
public:
    TestOfferInExecutor1(LinkedBlockingQueue<int>* queue,
                         LinkedBlockingQueueTest*  test)
        : Runnable(),
          queue(queue),
          test(test)
    ...
    virtual void run()
    {
        ...
        try
        {
            test->threadAssertTrue(
                queue->offer(3,
                             LinkedBlockingQueueTest::MEDIUM_DELAY_MS,
                             TimeUnit::MILLISECONDS));
...
public:
    TestOfferInExecutor2(LinkedBlockingQueue<int>* queue,
                         LinkedBlockingQueueTest*  test)
        : Runnable(),
          queue(queue),
          test(test)
...
public:
    TestPollInExecutor1(LinkedBlockingQueue<int>* queue,
                        LinkedBlockingQueueTest*  test)
        : Runnable(),
          queue(queue),
          test(test)
...
public:
    TestPollInExecutor2(LinkedBlockingQueue<int>* queue,
                        LinkedBlockingQueueTest*  test)
        : Runnable(),
          queue(queue),
          test(test)
