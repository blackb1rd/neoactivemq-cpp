...
TEST_F(TimeUnitTest, testConvert1)
{
    for (long long t = 0; t < 10; ++t)
    {
        ...
        ASSERT_TRUE(
            t == TimeUnit::SECONDS.convert(1000 * t, TimeUnit::MILLISECONDS));
        ASSERT_TRUE(t == TimeUnit::SECONDS.convert(1000000 * t,
                                                   TimeUnit::MICROSECONDS));
        ASSERT_TRUE(t == TimeUnit::SECONDS.convert(1000000000 * t,
                                                   TimeUnit::NANOSECONDS));
        ASSERT_TRUE(1000 * t ==
                    TimeUnit::MILLISECONDS.convert(t, TimeUnit::SECONDS));
        ASSERT_TRUE(t ==
                    TimeUnit::MILLISECONDS.convert(t, TimeUnit::MILLISECONDS));
        ASSERT_TRUE(
            t ==
            TimeUnit::MILLISECONDS.convert(1000 * t, TimeUnit::MICROSECONDS));
        ASSERT_TRUE(t == TimeUnit::MILLISECONDS.convert(1000000 * t,
                                                        TimeUnit::NANOSECONDS));
        ASSERT_TRUE(1000000 * t ==
                    TimeUnit::MICROSECONDS.convert(t, TimeUnit::SECONDS));
        ASSERT_TRUE(1000 * t ==
                    TimeUnit::MICROSECONDS.convert(t, TimeUnit::MILLISECONDS));
        ASSERT_TRUE(t ==
                    TimeUnit::MICROSECONDS.convert(t, TimeUnit::MICROSECONDS));
        ASSERT_TRUE(t == TimeUnit::MICROSECONDS.convert(1000 * t,
                                                        TimeUnit::NANOSECONDS));
        ASSERT_TRUE(1000000000 * t ==
                    TimeUnit::NANOSECONDS.convert(t, TimeUnit::SECONDS));
        ASSERT_TRUE(1000000 * t ==
                    TimeUnit::NANOSECONDS.convert(t, TimeUnit::MILLISECONDS));
        ASSERT_TRUE(1000 * t ==
                    TimeUnit::NANOSECONDS.convert(t, TimeUnit::MICROSECONDS));
        ASSERT_TRUE(t ==
                    TimeUnit::NANOSECONDS.convert(t, TimeUnit::NANOSECONDS));
    }
}
...
TEST_F(TimeUnitTest, testConvert2)
{
    for (long long t = 0; t < 10; ++t)
    {
        ...
        ASSERT_TRUE(
            t == TimeUnit::SECONDS.convert(t * 1000, TimeUnit::MILLISECONDS));
        ASSERT_TRUE(
            t ==
            TimeUnit::MILLISECONDS.convert(t * 1000, TimeUnit::MICROSECONDS));
        ASSERT_TRUE(t == TimeUnit::MICROSECONDS.convert(t * 1000,
                                                        TimeUnit::NANOSECONDS));
...
TEST_F(TimeUnitTest, testToMinutes)
{
    for (long long t = 0; t < 10; ++t)
    {
        ...
        ASSERT_TRUE(t ==
                    TimeUnit::NANOSECONDS.toMinutes(t * 1000000000LL * 60));
    }
}
...
TEST_F(TimeUnitTest, testToHours)
{
    for (long long t = 0; t < 10; ++t)
    {
        ...
        ASSERT_TRUE(t ==
                    TimeUnit::MICROSECONDS.toHours(t * 1000000LL * 60 * 60));
        ASSERT_TRUE(t ==
                    TimeUnit::NANOSECONDS.toHours(t * 1000000000LL * 60 * 60));
    }
}
...
TEST_F(TimeUnitTest, testToDays)
{
    for (long long t = 0; t < 10; ++t)
    {
        ...
        ASSERT_TRUE(t ==
                    TimeUnit::MILLISECONDS.toDays(t * 1000LL * 60 * 60 * 24));
        ASSERT_TRUE(
            t == TimeUnit::MICROSECONDS.toDays(t * 1000000LL * 60 * 60 * 24));
        ASSERT_TRUE(
            t == TimeUnit::NANOSECONDS.toDays(t * 1000000000LL * 60 * 60 * 24));
    }
}
