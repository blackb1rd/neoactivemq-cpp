...
TEST_F(DeflaterOutputStreamTest, testConstructorOutputStreamDeflater)
{
    ...
    ASSERT_EQ((std::size_t)512, dos.getProtectedBuf().size())
        << ("Incorrect Buffer Size for new DeflaterOutputStream");
...
TEST_F(DeflaterOutputStreamTest, testConstructorOutputStreamDeflaterI)
{
    ...
    ASSERT_EQ((std::size_t)5, dos.getProtectedBuf().size())
        << ("Incorrect Buffer Size for new DeflaterOutputStream");
...
TEST_F(DeflaterOutputStreamTest, testClose)
{
    ...
    // Test for a zero buf.
    ASSERT_THROW(dos.write(5), IOException)
...
TEST_F(DeflaterOutputStreamTest, testFinish)
{
    ...
    ASSERT_THROW(dos.write(1), IOException)
